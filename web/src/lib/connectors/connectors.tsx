...
> = {
  ...
  web: {
    ...
    values: [
      {
        type: "text",
        query: "Enter the website URL to scrape e.g. https://docs.esa.app/:",
        label: "Base URL",
        name: "base_url",
        optional: false,
      },
  ...
  google_drive: {
            ...
            fields: [
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow ESA to index everything in the shared drives you have access to."
                    : "This will allow ESA to index everything in your Organization's shared drives.";
                },
              ...
              },
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow ESA to index everything in your My Drive."
                    : "This will allow ESA to index everything in everyone's My Drives.";
                },
              ...
              },
              {
                type: "checkbox",
                description:
                  "This will allow ESA to index all files shared with you.",
    ...
    advanced_values: [
      ...
      },
      {
        ...
        description:
          "When enabled, ESA skips files that are shared broadly (domain or public) but require the link to access.",
            ...
            fields: [
              {
                ...
                optional: true,
                description:
                  "Specify the Salesforce object types you want us to index. If unsure, don't specify any objects and ESA will default to indexing by 'Account'." +
...
• Specifying 'https://esaai.sharepoint.com/sites/support' for example only indexes this site.
• Specifying 'https://esaai.sharepoint.com/sites/support/subfolder' for example only indexes this folder.
• Specifying sites currently works for SharePoint instances using English, Spanish, or German. Contact the ESA team if you need another language supported.
`,
      },
    ],
    advanced_values: [
    ...
    values: [
      {
        ...
        name: "teams",
        optional: true,
        description: `Specify 0 or more Teams to index. For example, specifying the Team 'Support' for the 'esaai' Org will cause us to only index messages sent in channels belonging to the 'Support' Team. If no Teams are specified, all Teams in your organization will be indexed.`,
      },
    ],
    advanced_values: [],
  },
...
For example, specifying .*-support.* as a "channel" will cause the connector to include any channels with "-support" in the name.`,
    ...
    values: [
      {
        ...
        name: "base_url",
        optional: false,
        description: `Specify the base URL for your Slab team. This will look something like: https://esa.slab.com/`,
      },
    ],
    advanced_values: [],
  },
  ...
  servicenow: {
    description: "Configure ServiceNow connector",
    subtext: "Index Incidents, Knowledge Base, Service Catalog, and more.",
    values: [
      {
        type: "select",
        ...
        optional: false,
        options: [
          { name: "All ITSM (Incidents, Problems, Changes, Tasks)", value: "all_itsm" },
          { name: "Everything (ITSM + KB + CMDB)", value: "all" },
          { name: "Incidents Only", value: "incidents" },
          { name: "Problems Only", value: "problems" },
          { name: "Change Requests Only", value: "changes" },
          { name: "Knowledge Articles", value: "knowledge" },
          { name: "CMDB - Servers", value: "cmdb_servers" },
          { name: "CMDB - Applications", value: "cmdb_applications" },
          { name: "CMDB - All Configuration Items", value: "cmdb_all" },
          { name: "Service Requests", value: "requests" },
          { name: "CSM Cases", value: "csm_cases" },
          { name: "HR Cases", value: "hr_cases" },
          { name: "Security Incidents", value: "security_incidents" },
          { name: "Service Catalog Items", value: "catalog_items" },
        ],
        default: "all_itsm",
      },
      {
        type: "text",
        query: "Enter custom tables to index (optional):",
        label: "Custom Tables",
        name: "custom_tables",
        optional: true,
        description:
          "Comma-separated list of additional ServiceNow tables to index (e.g., u_my_custom_table, x_custom_app_records).",
      },
    ],
    advanced_values: [
      {
        ...
        optional: true,
        description:
          "Restricts how many ServiceNow API calls this connector can make per minute. Leave empty for no rate limiting.",
      },
    ],
    overrideDefaultFreq: 60 * 60 * 6, // Every 6 hours
  },
};
