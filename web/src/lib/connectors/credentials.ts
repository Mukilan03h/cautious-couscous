...
export interface ServiceNowCredentialJson {
  servicenow_instance_url: string;
  servicenow_username: string;
  servicenow_password: string;
  servicenow_client_id?: string | null;
  servicenow_client_secret?: string | null;
}
...
export const credentialTemplates: Record<ValidSources, any> = {
  ...
  servicenow: {
    ...
    servicenow_username: "",
    servicenow_password: "",
    servicenow_client_id: null,
    servicenow_client_secret: null,
  } as ServiceNowCredentialJson,
};
...
export const credentialDisplayNames: Record<string, string> = {
  ...
  // ServiceNow
  servicenow_instance_url: "ServiceNow Instance URL (e.g., mycompany.service-now.com)",
