...
export const FINAL_SETUP_CONFIG: FinalStepItemProps[] = [
  {
    ...
    description: "Enable ESA to search the internet for information.",
    icon: SvgGlobe,
...
export const MODAL_CONTENT_MAP: Record<string, any> = {
  [LLMProviderName.OPENAI]: {
    ...
    field_metadata: {
      ...
      default_model_name:
        "This model will be used by ESA by default for chatGPT.",
    },
  },
  [LLMProviderName.ANTHROPIC]: {
    ...
    field_metadata: {
      ...
      default_model_name:
        "This model will be used by ESA by default for Claude.",
    },
  },
  [LLMProviderName.OLLAMA_CHAT]: {
    ...
    field_metadata: {
      ...
      default_model_name:
        "This model will be used by ESA by default for Ollama.",
    },
  },
  [LLMProviderName.VERTEX_AI]: {
    ...
    field_metadata: {
      ...
      default_model_name:
        "This model will be used by ESA by default for Gemini.",
    },
  },
  [LLMProviderName.AZURE]: {
    ...
    field_metadata: {
      ...
      default_model_name:
        "This model will be used by ESA by default for Azure OpenAI.",
    },
  },
  [LLMProviderName.OPENROUTER]: {
    ...
    field_metadata: {
      ...
      default_model_name:
        "This model will be used by ESA by default for OpenRouter.",
    },
  },
