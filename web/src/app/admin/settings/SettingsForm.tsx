  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use ESA."
          ...
          <Modal.Content medium>
            ...
            <Modal.Body>
              <p>
                ...
                anyone to use ESA without signing in.
              </p>
            </Modal.Body>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like ESA to retain chat messages. Leaving this field empty will cause ESA to never delete chat messages."
