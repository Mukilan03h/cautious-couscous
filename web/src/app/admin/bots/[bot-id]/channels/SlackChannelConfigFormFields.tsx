      ...
      <div className="w-full">
          ...
          <>
            ...
            <div className="mt-4 p-4 bg-background rounded-md border border-neutral-300">
              ...
              <p className="mt-2 text-sm italic">
                Warning: Disabling the default configuration means ESABot
                won&apos;t respond in Slack channels unless they are explicitly
                configured. Additionally, ESABot will not respond to DMs.
              </p>
            </div>
          </>
        )}
        ...
        <div className="space-y-2 mt-4">
          ...
          >
            <RadioGroupItemField
              ...
              sublabel="Let ESABot respond based on information from all public connectors"
            />
        ...
        {values.knowledge_source === "document_sets" &&
          documentSets.length > 0 && (
            <div className="mt-4">
              <SubLabel>
                <>
                  Select the document sets ESABot will use while answering
                  questions in Slack.
                  <br />
                        ...
                        <div className="mb-3 mt-2 flex gap-2 flex-wrap text-sm">
                          {unselectableSets.map((documentSet) => (
                            <DocumentSetSelectable
                              ...
                              documentSet={documentSet}
                              disabled
                              disabledTooltip="Unable to use this document set because it contains a connector with auto-sync permissions. ESABot's responses in this channel are visible to all Slack users, so mirroring the asker's permissions could inadvertently expose private information."
                              isSelected={false}
                              onSelect={() => {}}
                            />
                          ))}
        ...
        {values.knowledge_source === "assistant" && (
          <div className="mt-4">
            <SubLabel>
              <>
                Select the search-enabled assistant ESABot will use while
        ...
        {values.knowledge_source === "non_search_assistant" && (
          <div className="mt-4">
            <SubLabel>
              <>
                Select the non-search assistant ESABot will use while answering
                questions in Slack.
                {syncEnabledAssistants.length > 0 && (
                  <>
                    <br />
              ...
              <div className="space-y-4 pb-3">
                <div className="w-64">
                  <SelectorFormField
                    name="response_type"
                    label="Answer Type"
                    tooltip="Controls the format of ESABot's responses."
                    options={[
          ...
          <AccordionContent className="overflow-visible">
            <div className="space-y-4">
              <CheckFormField
                ...
                tooltip="If set, will show a button at the bottom of the response that allows the user to continue the conversation in the ESA Web UI"
              />
              ...
              <CheckFormField
                ...
                tooltip={`ESABot's response will include a button at the bottom
              ...
              <CheckFormField
                ...
                tooltip="If set, ESABot will only respond to messages that contain a question mark"
              />
              <CheckFormField
                name="respond_tag_only"
                label="Respond to @ESABot Only"
                tooltip="If set, ESABot will only respond when directly tagged"
              />
              <CheckFormField
                name="respond_to_bots"
                label="Respond to Bot messages"
                tooltip="If not set, ESABot will always ignore messages from Bots"
              />
              <CheckFormField
                name="is_ephemeral"
                label="Respond to user in a private (ephemeral) message"
                tooltip="If set, ESABot will respond only to the user in a private (ephemeral) message. If you also
              ...
              <TextArrayField
                ...
                subtext={
                  "If specified, ESABot responses will only " +
