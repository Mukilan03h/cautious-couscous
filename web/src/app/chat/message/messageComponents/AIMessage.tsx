...
import { ESADocument } from "@/lib/search/interfaces";
...
export default function AIMessage({
  ...
  const documentMapRef = useRef<Map<string, ESADocument>>(new Map());
  ...
  return (
    <>
      ...
      <div
        // for e2e tests
        data-testid={displayComplete ? "esa-ai-message" : undefined}
