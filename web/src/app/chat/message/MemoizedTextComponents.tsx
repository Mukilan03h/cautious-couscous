...
import { LoadedESADocument, ESADocument } from "@/lib/search/interfaces";
...
export const MemoizedAnchor = memo(
  ({
    ...
    updatePresentingDocument: (doc: ESADocument) => void;
    href?: string;
    ...
    if (value?.startsWith("[") && value?.endsWith("]")) {
      ...
      if (match) {
        ...
        if (match_item !== undefined) {
          ...
          let associatedDoc: ESADocument | null = null;
  ...
  ({
    ...
    const documentCardProps: DocumentCardProps | undefined =
      document && updatePresentingDocument
        ? {
            url: document.link,
            document: document as LoadedESADocument,
            updatePresentingDocument: updatePresentingDocument!,
          }
        : undefined;
