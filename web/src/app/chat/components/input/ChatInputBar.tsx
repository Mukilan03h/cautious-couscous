...
export interface ChatInputBarProps {
  ...
  setPresentingDocument?: (document: MinimalESADocument) => void;
...
function ChatInputBarInner({
  ...
  // Convert ProjectFile to MinimalESADocument format for viewing
  const handleFileClick = useCallback(
    (file: ProjectFile) => {
      if (!setPresentingDocument) return;

      const documentForViewer: MinimalESADocument = {
