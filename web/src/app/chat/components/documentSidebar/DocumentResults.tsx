import { MinimalESADocument, ESADocument } from "@/lib/search/interfaces";
...
// Build an ESADocument from basic file info
const buildESADocumentFromFile = (
  id: string,
  name?: string | null,
...
interface DocumentResultsProps {
  closeSidebar: () => void;
  selectedDocuments: ESADocument[] | null;
  toggleDocumentSelection: (document: ESADocument) => void;
  clearSelectedDocuments: () => void;
  selectedDocumentTokens: number;
  maxTokens: number;
  isSharedChat?: boolean;
  modal: boolean;
  setPresentingDocument: Dispatch<SetStateAction<MinimalESADocument | null>>;
}
            ...
            <ChatDocumentDisplayWrapper>
              {humanFileDescriptors.map((file) => (
                <ChatDocumentDisplay
                  ...
                  closeSidebar={closeSidebar}
                  modal={modal}
                  document={buildESADocumentFromFile(
                    file.id,
                    file.name,
                    false
                  )}
