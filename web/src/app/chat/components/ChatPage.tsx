...
import { ESAInitializingLoader } from "@/components/ESAInitializingLoader";
import { ESADocument, MinimalESADocument } from "@/lib/search/interfaces";
...
export default function ChatPage({
  ...
  const [presentingDocument, setPresentingDocument] =
    useState<MinimalESADocument | null>(null);
  ...
  const [selectedDocuments, setSelectedDocuments] = useState<ESADocument[]>(
    []
  );
  ...
  const toggleDocumentSelection = useCallback((document: ESADocument) => {
  ...
  if (!isReady) return <ESAInitializingLoader />;
