        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving ESA for your team. This will replace 'ESA' everywhere in the UI.`}
              placeholder="Custom name which will replace 'ESA'"
            ...
            <div>
              ...
              {values.use_custom_logo ? (
                ...
                <SubLabel>
                  Specify your own logo to replace the standard ESA logo.
                </SubLabel>
              )}
