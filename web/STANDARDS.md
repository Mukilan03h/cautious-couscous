...
**Reason:** We have a very carefully curated selection of icons that match our ESA guidelines. We do NOT want to muddy those up with different aesthetic stylings.
...
If you need help with this step, reach out to `raunak@esa.app`.
...
**Reason:** We've put in a lot of effort to unify the components that are rendered in the ESA app. Using raw components breaks the entire UI of the application, and leaves it in a muddier state than before.
