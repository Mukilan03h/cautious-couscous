...
3. From the dropdown at the top, select "Run All ESA Services" and press the green play button
4. Now, you can navigate to esa in your browser (default is http://localhost:3000) and start using the app
