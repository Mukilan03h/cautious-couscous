"""
User Group Models for MyPlatform.
Ported from ee/esa/server/user_group/models.py (97 lines)

Pydantic models for user group API operations.
"""
from uuid import UUID

from pydantic import BaseModel

from esa.db.models import UserGroup as UserGroupModel
from esa.server.documents.models import ConnectorCredentialPairDescriptor
from esa.server.documents.models import ConnectorSnapshot
from esa.server.documents.models import CredentialSnapshot
from esa.server.features.document_set.models import DocumentSet
