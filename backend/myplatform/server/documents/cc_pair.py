"""
CC Pair sync API endpoints for MyPlatform.
Ported from ee/esa/server/documents/cc_pair.py
"""
...
from myplatform.background.celery.tasks.doc_permission_syncing.tasks import (
    try_creating_permissions_sync_task,
)
from myplatform.background.celery.tasks.external_group_syncing.tasks import (
