"""
Tenant Provisioning for MyPlatform.
Ported from ee/esa/server/tenants/provisioning.py - FULL VERSION (579 lines)

Provides complete tenant provisioning, setup, and management functionality.
"""
import asyncio
import logging
import uuid
...
from myplatform.configs.app_configs import ANTHROPIC_DEFAULT_API_KEY
from myplatform.configs.app_configs import COHERE_DEFAULT_API_KEY
from myplatform.configs.app_configs import HUBSPOT_TRACKING_URL
from myplatform.configs.app_configs import OPENAI_DEFAULT_API_KEY
from myplatform.server.tenants.access import generate_data_plane_token
from myplatform.server.tenants.models import TenantByDomainResponse
from myplatform.server.tenants.models import TenantCreationPayload
from myplatform.server.tenants.models import TenantDeletionPayload
from myplatform.server.tenants.schema_management import create_schema_if_not_exists
from myplatform.server.tenants.schema_management import drop_schema
from myplatform.server.tenants.schema_management import run_alembic_migrations
from myplatform.server.tenants.user_mapping import add_users_to_tenant
from myplatform.server.tenants.user_mapping import get_tenant_id_for_email
from myplatform.server.tenants.user_mapping import user_owns_a_tenant
from esa.auth.users import exceptions
...
from esa.db.engine.sql_engine import get_session_with_shared_schema
from esa.db.engine.sql_engine import get_session_with_tenant
from esa.db.llm import update_default_provider
from esa.db.llm import upsert_cloud_embedding_provider
from esa.db.llm import upsert_llm_provider
from esa.db.models import AvailableTenant
from esa.db.models import IndexModelStatus
from esa.db.models import SearchSettings
from esa.db.models import UserTenantMapping
from esa.llm.llm_provider_options import ANTHROPIC_PROVIDER_NAME
from esa.llm.llm_provider_options import get_anthropic_model_names
from esa.llm.llm_provider_options import get_openai_model_names
from esa.llm.llm_provider_options import OPENAI_PROVIDER_NAME
from esa.server.manage.embedding.models import CloudEmbeddingProviderCreationRequest
...
async def setup_tenant(tenant_id: str) -> None:
    ...
    try:
        ...
        with get_session_with_tenant(tenant_id=tenant_id) as db_session:
            ...
            # Set up ESA with appropriate settings
            ...
            setup_esa(db_session, tenant_id, cohere_enabled=cohere_enabled)
...
# Additional provisioning utilities
...
def provision_new_tenant(
    ...
    """
    Synchronous wrapper for tenant provisioning.
    Used by background tasks.
    """
    asyncio.run(provision_tenant(tenant_id, admin_email))
...
def deprovision_tenant(
    ...
    If hard_delete is True, permanently delete all data.
    """
