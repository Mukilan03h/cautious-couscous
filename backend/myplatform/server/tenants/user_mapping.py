"""
User Mapping for MyPlatform.
Ported from ee/esa/server/tenants/user_mapping.py - FULL VERSION (335 lines)

Handles mapping users to tenants in multi-tenant setups.
"""
from fastapi_users import exceptions
from sqlalchemy import select

from esa.auth.invited_users import get_invited_users
from esa.auth.invited_users import get_pending_users
from esa.auth.invited_users import write_invited_users
from esa.auth.invited_users import write_pending_users
