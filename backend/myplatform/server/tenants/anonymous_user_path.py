"""
Anonymous User Path Management for MyPlatform.
Ported from ee/esa/server/tenants/anonymous_user_path.py (60 lines)

Handles anonymous user path validation and lookup.
"""
from sqlalchemy import select
from sqlalchemy.orm import Session

from esa.db.models import TenantAnonymousUserPath
