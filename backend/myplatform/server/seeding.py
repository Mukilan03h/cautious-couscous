"""
Seeding module for MyPlatform.
Ported from ee/esa/server/seeding.py - FULL ENTERPRISE VERSION (257 lines)

Provides initial data seeding for LLMs, personas, settings, custom tools, etc.
"""
import json
import os
...
from myplatform.db.standard_answers import create_category as create_initial_default_standard_answer_category
...
from myplatform.server.enterprise_settings.models import NavigationItem
from myplatform.server.enterprise_settings.store import store_analytics_script
from myplatform.server.enterprise_settings.store import (
...
from esa.db.persona import upsert_persona
...
from esa.server.settings.models import Settings
from esa.server.settings.store import store_settings as store_base_settings
...
def seed_db() -> None:
    ...
    with get_session_with_current_tenant() as db_session:
        ...
        try:
            create_initial_default_standard_answer_category(db_session, "default")
        except Exception:
            pass  # Already exists
