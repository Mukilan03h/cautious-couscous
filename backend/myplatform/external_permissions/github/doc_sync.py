"""GitHub document permission sync for MyPlatform."""
...
def github_doc_sync(
    ...
    """Sync document permissions from GitHub."""
    from esa.connectors.github.connector import GithubConnector
    
    connector = GithubConnector(**cc_pair.connector.connector_specific_config)
    ...
    yield from generic_doc_sync(
        ...
        callback=callback,
        doc_source=DocumentSource.GITHUB,
        slim_connector=connector,
        label="GitHub Permission Sync",
    )
