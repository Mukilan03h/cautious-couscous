"""
Jira page/project access permissions.
Ported from ee/esa/external_permissions/jira/page_access.py
"""
...
from myplatform.external_permissions.jira.models import Holder
...
def _build_holder_map(permissions: list[dict]) -> dict[str, list[Holder]]:
    ...
    This function constructs a map of "Holder" types to a list of the "Holder"s.
    ...
    for raw_perm in permissions:
        ...
        # If no holder exists, we cannot associate this permission to anyone
