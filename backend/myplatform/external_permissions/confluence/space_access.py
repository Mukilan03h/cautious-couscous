"""
Space access permissions for Confluence.
Ported from ee/esa/external_permissions/confluence/space_access.py
"""
from myplatform.configs.app_configs import CONFLUENCE_ANONYMOUS_ACCESS_IS_PUBLIC
from myplatform.external_permissions.confluence.constants import ALL_CONF_EMAILS_GROUP_NAME
from myplatform.external_permissions.confluence.constants import REQUEST_PAGINATION_LIMIT
from myplatform.external_permissions.confluence.constants import VIEWSPACE_PERMISSION_TYPE
from esa.access.models import ExternalAccess
from esa.connectors.confluence.esa_confluence import (
...
def _get_server_space_permissions(
    confluence_client: ESAConfluence, space_key: str
) -> ExternalAccess:
