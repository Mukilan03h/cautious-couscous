"""
Page access permissions for Confluence.
Ported from ee/esa/external_permissions/confluence/page_access.py
"""
...
def _extract_read_access_restrictions(
    confluence_client: ESAConfluence, restrictions: dict[str, Any]
