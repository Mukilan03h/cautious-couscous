"""
Confluence document permission sync for MyPlatform.
"""
...
def confluence_doc_sync(
    ...
    """Sync document permissions from Confluence."""
    from esa.connectors.confluence.connector import ConfluenceConnector
    
    connector = ConfluenceConnector(**cc_pair.connector.connector_specific_config)
    ...
    yield from generic_doc_sync(
        ...
        label="Confluence Permission Sync",
    )
