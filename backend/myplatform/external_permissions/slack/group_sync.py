"""
Slack group synchronization.
Ported from ee/esa/external_permissions/slack/group_sync.py
"""
"""
...
def slack_group_sync(
    ...
    provider = ESADBCredentialsProvider(tenant_id, "slack", cc_pair.credential.id)
    ...
    esa_groups: list[ExternalUserGroup] = []
