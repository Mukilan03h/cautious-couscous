"""
SharePoint document permission sync for MyPlatform.
"""
...
def sharepoint_doc_sync(
    ...
    """Sync document permissions from SharePoint."""
    from esa.connectors.sharepoint.connector import SharepointConnector
    
    connector = SharepointConnector(**cc_pair.connector.connector_specific_config)
    ...
    yield from generic_doc_sync(
        ...
        label="SharePoint Permission Sync",
    )
