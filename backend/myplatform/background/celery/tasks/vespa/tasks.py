"""
Vespa Tasks for MyPlatform.
Ported from ee/esa/background/celery/tasks/vespa/tasks.py (105 lines)

Handles user group sync monitoring and deletion for Vespa.
"""
...
from myplatform.db.user_group import delete_user_group
from myplatform.db.user_group import fetch_user_group
from myplatform.db.user_group import mark_user_group_as_synced
from myplatform.db.user_group import prepare_user_group_for_deletion
