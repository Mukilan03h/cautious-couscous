...
def start_docker_compose(
    ...
    command = (
        f"docker compose -f docker-compose.search-testing.yml -p esa-{env_name} up -d"
    )
    command += " --build"
...
if __name__ == "__main__":
    ...
    If no environment_name is indicated, will just clean up all esa docker containers/volumes/networks
