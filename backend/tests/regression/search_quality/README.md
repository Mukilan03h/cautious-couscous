...
1. Ensure you have the required dependencies installed and esa running.
...
3. Navigate to ESA repo, **search_quality** folder:

```
cd path/to/esa/backend/tests/regression/search_quality
```
...
python run_search_eval.py
  ...
  -e --api_endpoint     # Base URL of the ESA API server (default: http://127.0.0.1:8080)
