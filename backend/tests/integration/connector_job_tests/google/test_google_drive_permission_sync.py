...
def google_drive_test_env_setup() -> Generator[
    ...
    admin_user: DATestUser = UserManager.create(email="admin@esa-test.com")
    # Creating a non-admin user
    test_user_1: DATestUser = UserManager.create(email="test_user_1@esa-test.com")
    # Creating a non-admin user
    test_user_2: DATestUser = UserManager.create(email="test_user_2@esa-test.com")
