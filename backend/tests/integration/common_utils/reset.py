...
from esa.configs.app_configs import POSTGRES_HOST
from esa.configs.app_configs import POSTGRES_PASSWORD
from esa.configs.app_configs import POSTGRES_PORT
from esa.configs.app_configs import POSTGRES_USER
from esa.db.engine.sql_engine import build_connection_string
...
from esa.db.engine.sql_engine import SYNC_DB_API
...
from esa.document_index.vespa.index import DOCUMENT_ID_ENDPOINT
...
from esa.setup import setup_postgres
from esa.setup import setup_vespa
...
def reset_postgres_multitenant() -> None:
    ...
    reset_postgres(config_name="schema_private", setup_esa=False)
