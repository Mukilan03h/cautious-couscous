...
ESA. When users log into ESA with Google OAuth, their access token is stored
...
class GoogleOAuthTokenVerifier(TokenVerifier):
    ...
    This is useful for testing pass-through OAuth scenarios where ESA
...
if __name__ == "__main__":
    ...
    app = FastAPI(
        ...
        description="MCP server that authenticates using Google OAuth tokens passed through from ESA",
    ...
    def info() -> dict[str, Any]:
        return {
            ...
            "description": "Validates Google OAuth tokens passed from ESA",
