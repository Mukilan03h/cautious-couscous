...
from esa.background.celery.tasks.kg_processing.utils import (
...
from esa.kg.models import KGAttributeImplicationProperty
from esa.kg.models import KGAttributeProperty
...
from esa.kg.models import KGEntityTypeDefinition
...
def reset_for_test() -> None:
    ...
    kg_config_settings.KG_VENDOR_DOMAINS = ["esa-test.com.app", "tester.ai"]
...
def kg_test_docs() -> tuple[list[str], int, list[KGEntityType]]:
    ...
    # create admin user
    admin_user: DATestUser = UserManager.create(email="admin@esa-test.com.app")
