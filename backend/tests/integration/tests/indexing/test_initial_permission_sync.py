...
from esa.connectors.mock_connector.connector import EXTERNAL_USER_EMAILS
from esa.connectors.mock_connector.connector import EXTERNAL_USER_GROUP_IDS
from esa.connectors.mock_connector.connector import MockConnectorCheckpoint
...
def test_permission_sync_attempt_tracking_with_mocked_failure(
    ...
    with patch(
        "ee.esa.background.celery.tasks.doc_permission_syncing.tasks.validate_ccpair_for_user"
    ) as mock_validate:
