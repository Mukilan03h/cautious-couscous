...
from esa.connectors.gmail.connector import GmailConnector
...
This thread was 4 emails long:
    admin@esa-test.com -> test-group-1@esa-test.com (conaining test_user_1 and test_user_2)
    test_user_1@esa-test.com -> admin@esa-test.com
    admin@esa-test.com -> test_user_2@esa-test.com + BCC: test_user_3@esa-test.com
    test_user_3@esa-test.com -> admin@esa-test.com
"""
_THREAD_1_BY_ID: dict[str, dict[str, Any]] = {
    "192edefb315737c3": {
        "email": "admin@esa-test.com",
        "sections_count": 4,
        "primary_owners": set(
            [
                "admin@esa-test.com",
                "test_user_1@esa-test.com",
                "test_user_3@esa-test.com",
            ]
        ),
        "secondary_owners": set(
            [
                "test-group-1@esa-test.com",
                "admin@esa-test.com",
                "test_user_2@esa-test.com",
                "test_user_3@esa-test.com",
            ]
        ),
    },
    "192edf020d2f5def": {
        "email": "test_user_1@esa-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@esa-test.com", "test_user_1@esa-test.com"]),
        "secondary_owners": set(["test-group-1@esa-test.com", "admin@esa-test.com"]),
    },
    "192edf020ae90aab": {
        "email": "test_user_2@esa-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@esa-test.com"]),
        "secondary_owners": set(
            ["test-group-1@esa-test.com", "test_user_2@esa-test.com"]
        ),
    },
    "192edf18316015fa": {
        "email": "test_user_3@esa-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@esa-test.com", "test_user_3@esa-test.com"]),
        "secondary_owners": set(
            [
                "admin@esa-test.com",
                "test_user_2@esa-test.com",
...
@patch(
    "esa.file_processing.extract_file_text.get_unstructured_api_key",
    return_value=None,
)
