...
from esa.connectors.hubspot.connector import AVAILABLE_OBJECT_TYPES
from esa.connectors.hubspot.connector import HubSpotConnector
...
class TestHubSpotConnector:
    ...
    def test_ticket_with_none_content(self) -> None:
        ...
        with (
            patch("esa.connectors.hubspot.connector.HubSpot") as MockHubSpot,
