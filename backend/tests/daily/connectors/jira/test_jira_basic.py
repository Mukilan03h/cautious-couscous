...
def _test_jira_connector_basic(jira_connector: JiraConnector) -> None:
    ...
    assert story.metadata == {
        ...
        "reporter_email": "chris@esa.app",
        "assignee_email": "chris@esa.app",
    ...
    assert (
        section.text
        == "This is a critical request for super-human answer quality in ESA! We need magic!\n"
    )
    ...
    assert epic.metadata == {
        "priority": "Medium",
        "status": "Backlog",
        "reporter": "Founder ESA",
        "assignee": "Chris Weaver",
        "issuetype": "Epic",
        "created": "2025-04-16T16:55:53.068-0700",
        "reporter_email": "founders@esa.app",
        "assignee_email": "chris@esa.app",
        "project_name": "DailyConnectorTestProject",
        "project": "AS",
        "key": "AS-4",
