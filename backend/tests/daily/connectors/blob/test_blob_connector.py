...
from esa.connectors.blob.connector import BlobStorageConnector
...
@pytest.mark.parametrize(
    "blob_connector", [(BlobType.S3, "esa-connector-tests")], indirect=True
)
...
@pytest.mark.parametrize(
    "blob_connector",
    [(BlobType.R2, "esa-daily-connector-tests", {"european_residency": True})],
    indirect=True,
)
...
@pytest.mark.parametrize(
    "blob_connector", [(BlobType.GOOGLE_CLOUD_STORAGE, "esa-test-1")], indirect=True
)
