...
from esa.connectors.imap.connector import ImapConnector
...
@pytest.mark.parametrize(
    ...
    [
        [
            EmailDoc(
                subject="Testing",
                recipients=set(["admin@esa-test.com", "raunak@esa.app"]),
                body="Hello, testing.",
            ),
            EmailDoc(
                subject="Hello world",
                recipients=set(["admin@esa-test.com", "r@rabh.io", "raunak@esa.app"]),
