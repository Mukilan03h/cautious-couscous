...
ADMIN_EMAIL = "admin@esa-test.com"
TEST_USER_1_EMAIL = "test_user_1@esa-test.com"
TEST_USER_2_EMAIL = "test_user_2@esa-test.com"
TEST_USER_3_EMAIL = "test_user_3@esa-test.com"
