...
from esa.connectors.jira.connector import _perform_jql_search
from esa.connectors.jira.connector import process_jira_issue
...
def mock_jira_api_version() -> Generator[Any, Any, Any]:
    with patch("esa.connectors.jira.utils.JIRA_CLOUD_API_VERSION", "3"):
        with patch("esa.connectors.jira.utils.JIRA_SERVER_API_VERSION", "2"):
            yield
...
@patch("esa.connectors.jira.connector.JIRA_CONNECTOR_MAX_TICKET_SIZE", 50)
