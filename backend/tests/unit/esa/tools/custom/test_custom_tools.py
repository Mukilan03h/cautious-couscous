...
from esa.tools.tool_implementations.custom.custom_tool import CustomToolCallSummary
from esa.tools.tool_implementations.custom.custom_tool import (
...
class TestCustomTool(unittest.TestCase):
    ...
    @patch("esa.tools.tool_implementations.custom.custom_tool.requests.request")
