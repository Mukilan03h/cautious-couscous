...
from ee.esa.external_permissions.confluence.group_sync import confluence_group_sync
...
_EXPECTED_CONFLUENCE_GROUPS = [
    ExternalUserGroupSet(
        ...
        user_emails={"chris@esa.app", "yuhong@esa.app"},
    ...
    ExternalUserGroupSet(
        ...
        user_emails={"hagen@danswer.ai", "founders@esa.app", "pablo@esa.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
    ...
    ExternalUserGroupSet(
        ...
        user_emails={"yuhong@esa.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="All_Confluence_Users_Found_By_ESA",
        user_emails={
            "chris@esa.app",
            "founders@esa.app",
            "hagen@danswer.ai",
    ...
    ExternalUserGroupSet(
        id="bitbucket-users-esaai",
        user_emails={"oauth@esa.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="bitbucket-admins-esaai",
        user_emails={"oauth@esa.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
