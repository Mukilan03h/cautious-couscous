...
from esa.context.search.federated.slack_search import fetch_and_cache_channel_metadata
from esa.db.models import DocumentSet
from esa.db.models import FederatedConnector
from esa.db.models import FederatedConnector__DocumentSet
from esa.db.models import LLMProvider
from esa.db.models import Persona
from esa.db.models import Persona__DocumentSet
from esa.db.models import Persona__Tool
from esa.db.models import SlackBot
from esa.db.models import SlackChannelConfig
from esa.db.models import User
from esa.esabot.slack.listener import process_message
from esa.esabot.slack.models import ChannelType
from esa.db.tools import get_builtin_tool
from esa.tools.built_in_tools import SearchTool
...
class TestSlackBotFederatedSearch:
    ...
    def _setup_slack_mocks(self, channel_name: str) -> tuple[list, list]:
        ...
        patches = [
            ...
            patch("esa.context.search.federated.slack_search.query_slack"),
            patch("esa.esabot.slack.listener.get_channel_type_from_id"),
            patch("esa.context.search.utils.get_query_embeddings"),
        ]
    ...
    def _setup_query_slack_mock(
        ...
        from esa.context.search.federated.slack_search import SlackQueryResult
    ...
    @patch("esa.utils.gpu_utils.fast_gpu_status_request", return_value=False)
    @patch(
        "esa.document_index.vespa.index.VespaIndex.hybrid_retrieval", return_value=[]
    )
...
@patch("esa.context.search.federated.slack_search.get_redis_client")
@patch("esa.context.search.federated.slack_search.WebClient")
...
def test_slack_channel_config_eager_loads_persona(db_session: Session) -> None:
    ...
    """
    from esa.db.slack_channel_config import (
