...
# from esa.chat.turn.models import ChatTurnContext
# from esa.configs.app_configs import CODE_INTERPRETER_BASE_URL
# from esa.file_store.models import ChatFileType
# from esa.file_store.models import InMemoryChatFile
# from esa.file_store.utils import get_default_file_store
# from esa.server.query_and_chat.streaming_models import Packet
# from esa.server.query_and_chat.streaming_models import PythonToolDelta
# from esa.server.query_and_chat.streaming_models import PythonToolStart
# from esa.tools.tool_implementations.python.python_tool import PythonTool
# from esa.tools.tool_implementations_v2.code_interpreter_client import (
#     CodeInterpreterClient,
# )
# from esa.tools.tool_implementations_v2.python import _python_execution_core
# from esa.tools.tool_implementations_v2.python import python
# from esa.tools.tool_implementations_v2.tool_result_models import (
...
#     with patch(
#         "esa.tools.tool_implementations_v2.python.get_tool_by_name"
#     ) as mock_get_tool:
#         mock_tool = Mock()
#         mock_tool.id = 1
...
#         with patch(
#             "esa.tools.tool_implementations_v2.python.CODE_INTERPRETER_DEFAULT_TIMEOUT_MS",
#             1000,
#         ):
#             # Execute code
...
#     with patch(
#         "esa.tools.tool_implementations.python.python_tool.CODE_INTERPRETER_BASE_URL",
#         "http://localhost:8000",
#     ):
...
#     ) as mock_get_tool:
#         with patch(
#             "esa.tools.tool_implementations_v2.python.CodeInterpreterClient"
...
#         with patch(
#             "esa.tools.tool_implementations_v2.python.CODE_INTERPRETER_MAX_OUTPUT_LENGTH",
#             5000,
#         ):
#             mock_tool = Mock()
#             mock_tool.id = 1
