from esa.configs.app_configs import DISABLE_USER_KNOWLEDGE
from esa.configs.app_configs import ONYX_QUERY_HISTORY_TYPE
from esa.configs.app_configs import SHOW_EXTRA_CONNECTORS
from esa.configs.constants import KV_SETTINGS_KEY
...
def load_settings() -> Settings:
    ...
    try:
        ...
        if value is not None:
            ...
            redis_client.set(ESARedisLocks.ANONYMOUS_USER_ENABLED, "0")
    except Exception as e:
...
def store_settings(settings: Settings) -> None:
    ...
    if settings.anonymous_user_enabled is not None:
        redis_client.set(
            ESARedisLocks.ANONYMOUS_USER_ENABLED,
