...
from esa.db.credentials import alter_credential
from esa.db.credentials import cleanup_gmail_credentials
from esa.db.credentials import create_credential
from esa.db.credentials import CREDENTIAL_PERMISSIONS_TO_IGNORE
from esa.db.credentials import delete_credential
from esa.db.credentials import delete_credential_for_user
from esa.db.credentials import fetch_credential_by_id_for_user
from esa.db.credentials import fetch_credentials_by_source_for_user
from esa.db.credentials import fetch_credentials_for_user
from esa.db.credentials import swap_credentials_connector
from esa.db.credentials import update_credential
from esa.db.engine.sql_engine import get_session
from esa.db.models import DocumentSource
from esa.db.models import User
from esa.server.documents.models import CredentialBase
from esa.server.documents.models import CredentialDataUpdateRequest
from esa.server.documents.models import CredentialSnapshot
from esa.server.documents.models import CredentialSwapRequest
from esa.server.documents.models import ObjectCreationIdResponse
from esa.server.documents.private_key_types import FILE_TYPE_TO_FILE_PROCESSOR
from esa.server.documents.private_key_types import PrivateKeyFileTypes
from esa.server.documents.private_key_types import ProcessPrivateKeyFileProtocol
...
def create_credential_from_model(
    ...
    logger.info(f"[create_credential] Received credential_info: source={credential_info.source}, name={credential_info.name}")
    logger.info(f"[create_credential] credential_json keys: {list(credential_info.credential_json.keys()) if credential_info.credential_json else 'None'}")
