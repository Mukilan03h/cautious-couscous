...
from esa.auth.users import current_curator_or_admin_user
from esa.auth.users import current_user
from esa.background.celery.versioned_apps.client import app as client_app
from esa.configs.app_configs import DISABLE_AUTH
from esa.configs.app_configs import ENABLED_CONNECTOR_TYPES
from esa.configs.app_configs import MOCK_CONNECTOR_FILE_PATH
...
from esa.configs.constants import ONYX_METADATA_FILENAME
from esa.configs.constants import ESACeleryPriority
from esa.configs.constants import ESACeleryTask
from esa.connectors.exceptions import ConnectorValidationError
from esa.connectors.factory import validate_ccpair_for_user
from esa.connectors.google_utils.google_auth import (
    get_google_oauth_creds,
)
from esa.connectors.google_utils.google_kv import (
...
from esa.connectors.google_utils.google_kv import get_auth_url
from esa.connectors.google_utils.google_kv import (
    get_google_app_cred,
)
from esa.connectors.google_utils.google_kv import (
...
from esa.connectors.google_utils.google_kv import verify_csrf
from esa.connectors.google_utils.shared_constants import DB_CREDENTIALS_DICT_TOKEN_KEY
from esa.connectors.google_utils.shared_constants import (
    GoogleOAuthAuthenticationMethod,
)
from esa.db.connector import create_connector
from esa.db.connector import delete_connector
from esa.db.connector import fetch_connector_by_id
from esa.db.connector import fetch_connectors
from esa.db.connector import fetch_unique_document_sources
from esa.db.connector import get_connector_credential_ids
from esa.db.connector import mark_ccpair_with_indexing_trigger
from esa.db.connector import update_connector
from esa.db.connector_credential_pair import add_credential_to_connector
from esa.db.connector_credential_pair import (
    fetch_connector_credential_pair_for_connector,
)
from esa.db.connector_credential_pair import get_cc_pair_groups_for_ids
from esa.db.connector_credential_pair import get_connector_credential_pair
from esa.db.connector_credential_pair import get_connector_credential_pairs_for_user
from esa.db.connector_credential_pair import (
    get_connector_credential_pairs_for_user_parallel,
)
from esa.db.credentials import cleanup_gmail_credentials
from esa.db.credentials import cleanup_google_drive_credentials
from esa.db.credentials import create_credential
from esa.db.credentials import delete_service_account_credentials
from esa.db.credentials import fetch_credential_by_id_for_user
from esa.db.deletion_attempt import check_deletion_attempt_is_allowed
from esa.db.document import get_document_counts_for_all_cc_pairs
...
from esa.db.enums import IndexingMode
from esa.db.federated import fetch_all_federated_connectors_parallel
from esa.db.index_attempt import get_index_attempts_for_cc_pair
from esa.db.index_attempt import get_latest_index_attempts_by_status
from esa.db.index_attempt import get_latest_index_attempts_parallel
from esa.db.models import ConnectorCredentialPair
from esa.db.models import FederatedConnector
from esa.db.models import IndexAttempt
from esa.db.models import IndexingStatus
from esa.db.models import User
from esa.db.models import UserRole
from esa.file_processing.extract_file_text import extract_file_text
from esa.file_store.file_store import get_default_file_store
from esa.file_store.models import ChatFileType
from esa.key_value_store.interface import KvKeyNotFoundError
from esa.server.documents.models import AuthStatus
from esa.server.documents.models import AuthUrl
from esa.server.documents.models import ConnectorCredentialPairIdentifier
from esa.server.documents.models import ConnectorIndexingStatusLite
from esa.server.documents.models import ConnectorIndexingStatusLiteResponse
from esa.server.documents.models import ConnectorSnapshot
from esa.server.documents.models import ConnectorStatus
from esa.server.documents.models import ConnectorUpdateRequest
from esa.server.documents.models import CredentialBase
from esa.server.documents.models import CredentialSnapshot
from esa.server.documents.models import DocsCountOperator
from esa.server.documents.models import FailedConnectorIndexingStatus
from esa.server.documents.models import FileUploadResponse
from esa.server.documents.models import GDriveCallback
from esa.server.documents.models import GmailCallback
from esa.server.documents.models import GoogleAppCredentials
from esa.server.documents.models import GoogleServiceAccountCredentialRequest
from esa.server.documents.models import GoogleServiceAccountKey
from esa.server.documents.models import IndexedSourcesResponse
from esa.server.documents.models import IndexingStatusRequest
from esa.server.documents.models import ObjectCreationIdResponse
from esa.server.documents.models import RunConnectorRequest
from esa.server.documents.models import SourceSummary
from esa.server.federated.models import FederatedConnectorStatus
from esa.server.models import StatusResponse
from esa.server.query_and_chat.chat_utils import mime_type_to_chat_file_type
from esa.utils.logger import setup_logger
from esa.utils.telemetry import create_milestone_and_report
from esa.utils.threadpool_concurrency import CallableProtocol
from esa.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from esa.utils.variable_functionality import fetch_ee_implementation_or_noop
...
def create_connector_from_model(
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "esa.db.user_group", "validate_object_creation_for_user", None
        )(
            db_session=db_session,
            user=user,
...
def create_connector_with_mock_credential(
    ...
    try:
        ...
        client_app.send_task(
            ESACeleryTask.CHECK_FOR_INDEXING,
            priority=ESACeleryPriority.HIGH,
...
def trigger_indexing_for_cc_pair(
    ...
    priority = ESACeleryPriority.HIGHEST if is_user_file else ESACeleryPriority.HIGH
