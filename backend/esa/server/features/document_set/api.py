...
from esa.db.document_set import check_document_sets_are_public
from esa.db.document_set import fetch_all_document_sets_for_user
from esa.db.document_set import get_document_set_by_id
from esa.db.document_set import insert_document_set
from esa.db.document_set import mark_document_set_as_to_be_deleted
from esa.db.document_set import update_document_set
from esa.db.engine.sql_engine import get_session
from esa.db.models import User
from esa.server.features.document_set.models import CheckDocSetPublicRequest
from esa.server.features.document_set.models import CheckDocSetPublicResponse
from esa.server.features.document_set.models import DocumentSetCreationRequest
from esa.server.features.document_set.models import DocumentSetSummary
...
def create_document_set(
    ...
    client_app.send_task(
        ESACeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
