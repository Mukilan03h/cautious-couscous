...
from esa.server.features.web_search.models import OpenUrlsToolRequest
from esa.server.features.web_search.models import OpenUrlsToolResponse
from esa.server.features.web_search.models import WebSearchToolRequest
from esa.server.features.web_search.models import WebSearchToolResponse
from esa.server.features.web_search.models import WebSearchWithContentResponse
...
from esa.tools.models import LlmOpenUrlResult
from esa.tools.models import LlmWebSearchResult
from esa.tools.tool_implementations.open_url.models import WebContentProvider
from esa.tools.tool_implementations.open_url.esa_web_crawler import (
    ESAWebCrawler,
)
...
from esa.tools.tool_implementations.web_search.utils import (
...
def _get_active_content_provider(
    ...
    if provider_model is None:
        ...
        # NOTE: the ESAWebCrawler is not stored in the content provider table,
        # so we need to return it directly.

        return None, ESAWebCrawler()
