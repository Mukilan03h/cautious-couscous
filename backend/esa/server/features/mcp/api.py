...
from esa.db.enums import MCPAuthenticationPerformer
from esa.db.enums import MCPAuthenticationType
from esa.db.enums import MCPServerStatus
from esa.db.enums import MCPTransport
from esa.db.mcp import create_connection_config
from esa.db.mcp import create_mcp_server__no_commit
from esa.db.mcp import delete_connection_config
from esa.db.mcp import delete_mcp_server
from esa.db.mcp import delete_user_connection_configs_for_server
from esa.db.mcp import get_all_mcp_servers
from esa.db.mcp import get_connection_config_by_id
from esa.db.mcp import get_mcp_server_by_id
from esa.db.mcp import get_mcp_servers_for_persona
from esa.db.mcp import get_server_auth_template
from esa.db.mcp import get_user_connection_config
from esa.db.mcp import update_connection_config
from esa.db.mcp import update_mcp_server__no_commit
from esa.db.mcp import upsert_user_connection_config
from esa.db.models import MCPConnectionConfig
from esa.db.models import MCPServer as DbMCPServer
from esa.db.models import Tool
from esa.db.models import User
from esa.db.tools import create_tool__no_commit
from esa.db.tools import delete_tool__no_commit
from esa.db.tools import get_tools_by_mcp_server_id
from esa.redis.redis_pool import get_redis_client
from esa.server.features.mcp.models import MCPApiKeyResponse
from esa.server.features.mcp.models import MCPAuthTemplate
from esa.server.features.mcp.models import MCPConnectionData
from esa.server.features.mcp.models import MCPOAuthCallbackResponse
from esa.server.features.mcp.models import MCPOAuthKeys
from esa.server.features.mcp.models import MCPServer
from esa.server.features.mcp.models import MCPServerCreateResponse
from esa.server.features.mcp.models import MCPServerSimpleCreateRequest
from esa.server.features.mcp.models import MCPServerSimpleUpdateRequest
from esa.server.features.mcp.models import MCPServersResponse
from esa.server.features.mcp.models import MCPServerUpdateResponse
from esa.server.features.mcp.models import MCPToolCreateRequest
from esa.server.features.mcp.models import MCPToolListResponse
from esa.server.features.mcp.models import MCPToolUpdateRequest
from esa.server.features.mcp.models import MCPUserCredentialsRequest
from esa.server.features.mcp.models import MCPUserOAuthConnectRequest
from esa.server.features.mcp.models import MCPUserOAuthConnectResponse
from esa.server.features.tool.models import ToolSnapshot
from esa.tools.tool_implementations.mcp.mcp_client import discover_mcp_tools
from esa.tools.tool_implementations.mcp.mcp_client import initialize_mcp_client
from esa.tools.tool_implementations.mcp.mcp_client import log_exception_group
...
class ESATokenStorage(TokenStorage):
    """
...
def make_oauth_provider(
    ...
    return OAuthClientProvider(
        ...
        storage=ESATokenStorage(connection_config_id, admin_config_id),
