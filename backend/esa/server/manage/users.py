...
from esa.auth.email_utils import send_user_email_invite
from esa.auth.invited_users import get_invited_users
from esa.auth.invited_users import remove_user_from_invited_users
from esa.auth.invited_users import write_invited_users
from esa.auth.noauth_user import fetch_no_auth_user
from esa.auth.noauth_user import set_no_auth_user_personalization
from esa.auth.noauth_user import set_no_auth_user_preferences
from esa.auth.schemas import UserRole
from esa.auth.users import anonymous_user_enabled
...
from esa.auth.users import optional_user
from esa.configs.app_configs import AUTH_BACKEND
from esa.configs.app_configs import AUTH_TYPE
from esa.configs.app_configs import AuthBackend
from esa.configs.app_configs import DEV_MODE
from esa.configs.app_configs import ENABLE_EMAIL_INVITES
from esa.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from esa.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from esa.configs.app_configs import VALID_EMAIL_DOMAINS
from esa.configs.constants import AuthType
from esa.configs.constants import FASTAPI_USERS_AUTH_COOKIE_NAME
from esa.db.api_key import is_api_key_email_address
from esa.db.auth import get_live_users_count
from esa.db.engine.sql_engine import get_session
from esa.db.enums import UserFileStatus
from esa.db.models import User
from esa.db.models import UserFile
from esa.db.user_preferences import activate_user
from esa.db.user_preferences import deactivate_user
from esa.db.user_preferences import get_all_user_assistant_specific_configs
from esa.db.user_preferences import get_latest_access_token_for_user
from esa.db.user_preferences import update_assistant_preferences
from esa.db.user_preferences import update_user_assistant_visibility
from esa.db.user_preferences import update_user_auto_scroll
from esa.db.user_preferences import update_user_default_model
from esa.db.user_preferences import update_user_personalization
from esa.db.user_preferences import update_user_pinned_assistants
from esa.db.user_preferences import update_user_role
from esa.db.user_preferences import update_user_shortcut_enabled
from esa.db.user_preferences import update_user_temperature_override_enabled
from esa.db.user_preferences import update_user_theme_preference
from esa.db.users import delete_user_from_db
from esa.db.users import get_all_users
from esa.db.users import get_page_of_filtered_users
from esa.db.users import get_total_filtered_users_count
from esa.db.users import get_user_by_email
from esa.db.users import validate_user_role_update
from esa.key_value_store.factory import get_kv_store
from esa.redis.redis_pool import get_raw_redis_client
from esa.server.documents.models import PaginatedReturn
from esa.server.features.projects.models import UserFileSnapshot
from esa.server.manage.models import AllUsersResponse
from esa.server.manage.models import AutoScrollRequest
from esa.server.manage.models import PersonalizationUpdateRequest
from esa.server.manage.models import TenantInfo
from esa.server.manage.models import TenantSnapshot
from esa.server.manage.models import ThemePreferenceRequest
from esa.server.manage.models import UserByEmail
from esa.server.manage.models import UserInfo
from esa.server.manage.models import UserPreferences
from esa.server.manage.models import UserRoleResponse
from esa.server.manage.models import UserRoleUpdateRequest
from esa.server.manage.models import UserSpecificAssistantPreference
from esa.server.manage.models import UserSpecificAssistantPreferences
from esa.server.models import FullUserSnapshot
from esa.server.models import InvitedUserSnapshot
from esa.server.models import MinimalUserSnapshot
...
from esa.utils.variable_functionality import (
...
async def test_upsert_user(
    ...
    user = await fetch_ee_implementation_or_noop(
        "esa.server.saml", "upsert_saml_user", None
    )(email=request.email)
...
def bulk_invite_users(
    ...
    if MULTI_TENANT:
        try:
            fetch_ee_implementation_or_noop(
                "esa.server.tenants.provisioning", "add_users_to_tenant", None
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "esa.server.tenants.billing", "register_tenant_users", None
        ...
        fetch_ee_implementation_or_noop(
            "esa.server.tenants.user_mapping", "remove_users_from_tenant", None
        )(new_invited_emails, tenant_id)
        raise e
...
def verify_user_logged_in(
    ...
    team_name = fetch_ee_implementation_or_noop(
        "esa.server.tenants.user_mapping", "get_tenant_id_for_email", None
    )(user.email)
    ...
    if MULTI_TENANT:
        if team_name != get_current_tenant_id():
            user_count = fetch_ee_implementation_or_noop(
                "esa.server.tenants.user_mapping", "get_tenant_count", None
            )(team_name)
        ...
        tenant_invitation = fetch_ee_implementation_or_noop(
            "esa.server.tenants.user_mapping", "get_tenant_invitation", None
        )(user.email)

    super_users_list = cast(
        list[str],
        fetch_versioned_implementation_with_fallback(
            "esa.configs.app_configs",
            "SUPER_USERS",
            [],
        ),
    )
