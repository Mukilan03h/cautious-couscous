...
from esa.context.search.models import SearchSettingsCreationRequest
...
from esa.db.search_settings import create_search_settings
from esa.db.search_settings import delete_search_settings
from esa.db.search_settings import get_current_search_settings
from esa.db.search_settings import get_embedding_provider_from_provider_type
...
from esa.db.search_settings import update_search_settings_status
from esa.document_index.document_index_utils import get_multipass_config
from esa.document_index.factory import get_default_document_index
from esa.file_processing.unstructured import delete_unstructured_api_key
from esa.file_processing.unstructured import get_unstructured_api_key
from esa.file_processing.unstructured import update_unstructured_api_key
from esa.natural_language_processing.search_nlp_models import clean_model_name
from esa.server.manage.embedding.models import SearchSettingsDeleteRequest
from esa.server.manage.models import FullModelVersionResponse
from esa.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if MULTI_TENANT and search_settings_new.enable_contextual_rag:
        raise HTTPException(
            ...
            detail="Contextual RAG disabled in ESA Cloud",
        )
