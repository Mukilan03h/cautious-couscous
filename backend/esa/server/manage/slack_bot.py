...
from esa.db.slack_bot import insert_slack_bot
from esa.db.slack_bot import remove_slack_bot
from esa.db.slack_bot import update_slack_bot
from esa.db.slack_channel_config import create_slack_channel_persona
from esa.db.slack_channel_config import fetch_slack_channel_config
from esa.db.slack_channel_config import fetch_slack_channel_configs
from esa.db.slack_channel_config import insert_slack_channel_config
from esa.db.slack_channel_config import remove_slack_channel_config
from esa.db.slack_channel_config import update_slack_channel_config
from esa.esabot.slack.config import validate_channel_name
from esa.server.manage.models import SlackBot
from esa.server.manage.models import SlackBotCreationRequest
from esa.server.manage.models import SlackChannelConfig
from esa.server.manage.models import SlackChannelConfigCreationRequest
from esa.server.manage.validate_tokens import validate_app_token
from esa.server.manage.validate_tokens import validate_bot_token
from esa.server.manage.validate_tokens import validate_user_token
...
def _form_channel_config(
    ...
    if respond_tag_only and respond_member_group_list:
        raise ValueError(
            "Cannot set ESABot to only respond to tags only and "
    ...
    if (
        ...
        raise ValueError(
            "Cannot set ESABot to respond to users in a private (ephemeral) message "
