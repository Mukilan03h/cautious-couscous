...
from esa.llm.utils import litellm_thinks_model_supports_image_input
from esa.llm.utils import model_is_reasoning_model
from esa.server.manage.llm.utils import is_reasoning_model
...
class LLMProviderDescriptor(BaseModel):
    ...
    def from_model(
        ...
        from esa.llm.llm_provider_options import get_provider_display_name
...
def _extract_vendor_from_model_name(model_name: str, provider: str) -> str | None:
    ...
    """
    from esa.llm.constants import OLLAMA_MODEL_TO_VENDOR
...
class ModelConfigurationView(BaseModel):
    ...
    def from_model(
        ...
        from esa.llm.model_name_parser import parse_litellm_model_name
