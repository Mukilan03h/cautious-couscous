...
from esa.auth.users import user_needs_to_be_verified
from esa.configs.app_configs import AUTH_TYPE
from esa.configs.app_configs import PASSWORD_MIN_LENGTH
from esa.configs.constants import DEV_VERSION_PATTERN
from esa.configs.constants import STABLE_VERSION_PATTERN
from esa.server.manage.models import AllVersions
from esa.server.manage.models import AuthTypeResponse
from esa.server.manage.models import ContainerVersions
from esa.server.manage.models import VersionResponse
...
def get_versions() -> AllVersions:
    """
    Fetches the latest stable and beta versions of ESA Docker images.
    ...
    """
    # Fetch the latest tags from DockerHub for each ESA component
    dockerhub_repos = [
        "esadotapp/esa-model-server",
        "esadotapp/esa-backend",
        "esadotapp/esa-web-server",
    ]
