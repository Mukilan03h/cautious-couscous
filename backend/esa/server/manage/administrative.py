...
from esa.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from esa.configs.constants import DocumentSource
from esa.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
from esa.configs.constants import ESACeleryPriority
from esa.configs.constants import ESACeleryTask
from esa.db.connector_credential_pair import get_connector_credential_pair_for_user
...
from esa.db.feedback import fetch_docs_ranked_by_boost_for_user
from esa.db.feedback import update_document_boost_for_user
from esa.db.feedback import update_document_hidden_for_user
from esa.db.index_attempt import cancel_indexing_attempts_for_ccpair
...
from esa.server.manage.models import BoostDoc
from esa.server.manage.models import BoostUpdateRequest
from esa.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    client_app.send_task(
        ESACeleryTask.CHECK_FOR_CONNECTOR_DELETION,
