...
from esa.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from esa.configs.app_configs import CELERY_RESULT_EXPIRES
from esa.configs.app_configs import REDIS_DB_NUMBER_CELERY
from esa.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
...
broker_transport_options = {
    "priority_steps": list(range(len(ESACeleryPriority))),
...
task_default_priority = ESACeleryPriority.MEDIUM
task_acks_late = True
