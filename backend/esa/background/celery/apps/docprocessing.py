...
from esa.configs.constants import POSTGRES_CELERY_WORKER_DOCPROCESSING_APP_NAME
...
celery_app.config_from_object("esa.background.celery.configs.docprocessing")
