...
from esa.db.index_attempt import get_last_attempt_for_cc_pair
...
def try_creating_docfetching_task(
    ...
    try:
        ...
        queue = (
            ESACeleryQueues.USER_FILES_INDEXING
            if cc_pair.is_user_file
            else ESACeleryQueues.CONNECTOR_DOC_FETCHING
        )

        # Send the task to Celery
        result = celery_app.send_task(
            ESACeleryTask.CONNECTOR_DOC_FETCHING_TASK,
            kwargs=dict(
