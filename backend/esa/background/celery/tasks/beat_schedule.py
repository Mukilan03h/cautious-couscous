...
from esa.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from esa.configs.app_configs import LLM_MODEL_UPDATE_API_URL
from esa.configs.constants import ONYX_CLOUD_CELERY_TASK_PREFIX
...
beat_task_templates: list[dict] = [
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_USER_FILE_PROCESSING,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_USER_FILE_PROJECT_SYNC,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ESACeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_USER_FILE_DELETE,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ESACeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ESACeleryTask.USER_FILE_DOCID_MIGRATION,
        "schedule": timedelta(minutes=10),
        "options": {
            "priority": ESACeleryPriority.HIGH,
            "expires": BEAT_EXPIRES_DEFAULT,
            "queue": ESACeleryQueues.USER_FILES_INDEXING,
        },
    },
    {
        "name": "check-for-kg-processing",
        "task": ESACeleryTask.CHECK_KG_PROCESSING,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_KG_PROCESSING_CLUSTERING_ONLY,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_INDEXING,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_CHECKPOINT_CLEANUP,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_INDEX_ATTEMPT_CLEANUP,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_CONNECTOR_DELETION,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ESACeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ESACeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CHECK_FOR_PRUNING,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ESACeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ESACeleryTask.MONITOR_BACKGROUND_PROCESSES,
        ...
        [
            {
                ...
                "task": ESACeleryTask.CHECK_FOR_DOC_PERMISSIONS_SYNC,
            ...
            },
            {
                ...
                "task": ESACeleryTask.CHECK_FOR_EXTERNAL_GROUP_SYNC,
                "schedule": timedelta(seconds=20),
                "options": {
                    "priority": ESACeleryPriority.MEDIUM,
                    "expires": BEAT_EXPIRES_DEFAULT,
    ...
    beat_task_templates.append(
        {
            ...
            "task": ESACeleryTask.CHECK_FOR_LLM_MODEL_UPDATE,
...
def make_cloud_generator_task(task: dict[str, Any]) -> dict[str, Any]:
    ...
    cloud_task["options"] = {}
    cloud_task["options"]["priority"] = ESACeleryPriority.HIGHEST
    ...
    cloud_task["task"] = ESACeleryTask.CLOUD_BEAT_TASK_GENERATOR
    cloud_task["kwargs"] = {}
...
beat_cloud_tasks: list[dict] = [
    # cloud specific tasks
    {
        ...
        "task": ESACeleryTask.CLOUD_MONITOR_ALEMBIC,
        "schedule": timedelta(hours=1),
        "options": {
            "queue": ESACeleryQueues.MONITORING,
            "priority": ESACeleryPriority.HIGH,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CLOUD_MONITOR_CELERY_QUEUES,
        "schedule": timedelta(seconds=30),
        "options": {
            "queue": ESACeleryQueues.MONITORING,
            "priority": ESACeleryPriority.HIGH,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CLOUD_CHECK_AVAILABLE_TENANTS,
        "schedule": timedelta(minutes=10),
        "options": {
            "queue": ESACeleryQueues.MONITORING,
            "priority": ESACeleryPriority.HIGH,
    ...
    },
    {
        ...
        "task": ESACeleryTask.CLOUD_MONITOR_CELERY_PIDBOX,
        ...
        [
            {
                ...
                "task": ESACeleryTask.MONITOR_CELERY_QUEUES,
            ...
            },
            {
                ...
                "task": ESACeleryTask.MONITOR_PROCESS_MEMORY,
                "schedule": timedelta(minutes=5),
                "options": {
                    "priority": ESACeleryPriority.LOW,
                    "expires": BEAT_EXPIRES_DEFAULT,
            ...
            },
            {
                ...
                "task": ESACeleryTask.CELERY_BEAT_HEARTBEAT,
                "schedule": timedelta(minutes=1),
                "options": {
                    "priority": ESACeleryPriority.HIGHEST,
                    "expires": BEAT_EXPIRES_DEFAULT,
                    "queue": ESACeleryQueues.PRIMARY,
                },
            },
        ]
    )
