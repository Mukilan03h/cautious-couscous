...
from esa.db.connector_credential_pair import add_deletion_failure_message
...
from esa.db.document_set import delete_document_set_cc_pair_relationship__no_commit
...
from esa.db.index_attempt import delete_index_attempts
from esa.db.index_attempt import get_recent_attempts_for_cc_pair
...
from esa.db.search_settings import get_all_search_settings
...
from esa.redis.redis_connector_delete import RedisConnectorDeletePayload
...
@shared_task(
    name=ESACeleryTask.CHECK_FOR_CONNECTOR_DELETION,
    ignore_result=True,
...
def check_for_connector_deletion_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        ESARedisLocks.CHECK_CONNECTOR_DELETION_BEAT_LOCK,
    ...
    try:
        ...
        lock_beat.reacquire()
        if not r.exists(ESARedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES):
            ...
            r.set(ESARedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES, 1, ex=300)
