...
from esa.configs.constants import ONYX_CELERY_BEAT_HEARTBEAT_KEY
from esa.configs.constants import ESACeleryTask
from esa.db.document import delete_document_by_connector_credential_pair__no_commit
from esa.db.document import delete_documents_complete__no_commit
from esa.db.document import fetch_chunk_count_for_document
from esa.db.document import get_document
from esa.db.document import get_document_connector_count
from esa.db.document import mark_document_as_modified
...
from esa.db.relationships import delete_document_references_from_kg
...
class ESACeleryTaskCompletionStatus(str, Enum):
...
@shared_task(
    name=ESACeleryTask.DOCUMENT_BY_CC_PAIR_CLEANUP_TASK,
...
def document_by_cc_pair_cleanup_task(
    ...
    if completion_status != ESACeleryTaskCompletionStatus.SUCCEEDED:
        return False
...
@shared_task(name=ESACeleryTask.CELERY_BEAT_HEARTBEAT, ignore_result=True, bind=True)
