...
from esa.access.access import get_access_for_document
...
from esa.background.celery.tasks.shared.tasks import LIGHT_SOFT_TIME_LIMIT
from esa.background.celery.tasks.shared.tasks import LIGHT_TIME_LIMIT
from esa.background.celery.tasks.shared.tasks import ESACeleryTaskCompletionStatus
from esa.background.celery.tasks.vespa.document_sync import DOCUMENT_SYNC_FENCE_KEY
from esa.background.celery.tasks.vespa.document_sync import get_document_sync_payload
from esa.background.celery.tasks.vespa.document_sync import get_document_sync_remaining
from esa.background.celery.tasks.vespa.document_sync import reset_document_sync
from esa.background.celery.tasks.vespa.document_sync import (
    try_generate_stale_document_sync_tasks,
)
from esa.configs.app_configs import JOB_TIMEOUT
from esa.configs.app_configs import VESPA_SYNC_MAX_TASKS
from esa.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT
...
from esa.db.document import get_document
from esa.db.document import mark_document_as_synced
from esa.db.document_set import delete_document_set
from esa.db.document_set import fetch_document_sets
from esa.db.document_set import fetch_document_sets_for_document
from esa.db.document_set import get_document_set_by_id
from esa.db.document_set import mark_document_set_as_synced
...
from esa.redis.redis_document_set import RedisDocumentSet
...
from esa.redis.redis_usergroup import RedisUserGroup
...
from esa.utils.variable_functionality import noop_fallback
...
@shared_task(
    name=ESACeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
    ignore_result=True,
...
def check_for_vespa_sync_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        ESARedisLocks.CHECK_VESPA_SYNC_BEAT_LOCK,
        ...
        if global_version.is_ee_version():
            try:
                fetch_user_groups = fetch_versioned_implementation(
                    "esa.db.user_group", "fetch_user_groups"
                )
        ...
        for key in keys:
            ...
            if key_str == DOCUMENT_SYNC_FENCE_KEY:
                ...
                monitor_usergroup_taskset = (
                    fetch_versioned_implementation_with_fallback(
                        "esa.background.celery.tasks.vespa.tasks",
                        "monitor_usergroup_taskset",
                        noop_fallback,
                    )
                )
...
def try_generate_user_group_sync_tasks(
    ...
    fetch_user_group = cast(
        ...
        fetch_versioned_implementation("esa.db.user_group", "fetch_user_group"),
    )
...
@shared_task(
    name=ESACeleryTask.VESPA_METADATA_SYNC_TASK,
    bind=True,
...
def vespa_metadata_sync_task(self: Task, document_id: str, *, tenant_id: str) -> bool:
    ...
    completion_status = ESACeleryTaskCompletionStatus.UNDEFINED
    ...
    try:
        with get_session_with_current_tenant() as db_session:
            ...
            if not doc:
                ...
                completion_status = ESACeleryTaskCompletionStatus.SKIPPED
            else:
                # document set sync
                ...
                completion_status = ESACeleryTaskCompletionStatus.SUCCEEDED
    except SoftTimeLimitExceeded:
        task_logger.info(f"SoftTimeLimitExceeded exception. doc={document_id}")
        completion_status = ESACeleryTaskCompletionStatus.SOFT_TIME_LIMIT
        ...
        while True:
            ...
            if isinstance(e, httpx.HTTPStatusError):
                ...
                completion_status = (
                    ESACeleryTaskCompletionStatus.NON_RETRYABLE_EXCEPTION
                )
                break
            ...
            completion_status = ESACeleryTaskCompletionStatus.RETRYABLE_EXCEPTION
            if (
    ...
    return completion_status == ESACeleryTaskCompletionStatus.SUCCEEDED
