...
from esa.access.access import source_should_fetch_permissions_during_indexing
from esa.background.indexing.checkpointing_utils import check_checkpoint_size
from esa.background.indexing.checkpointing_utils import get_latest_valid_checkpoint
from esa.background.indexing.checkpointing_utils import save_checkpoint
from esa.background.indexing.memory_tracer import MemoryTracer
from esa.configs.app_configs import INDEX_BATCH_SIZE
from esa.configs.app_configs import INDEXING_SIZE_WARNING_THRESHOLD
from esa.configs.app_configs import INDEXING_TRACER_INTERVAL
from esa.configs.app_configs import INTEGRATION_TESTS_MODE
from esa.configs.app_configs import LEAVE_CONNECTOR_ACTIVE_ON_INITIALIZATION_FAILURE
from esa.configs.app_configs import MAX_FILE_SIZE_BYTES
from esa.configs.app_configs import POLL_CONNECTOR_OFFSET
...
from esa.connectors.connector_runner import ConnectorRunner
from esa.connectors.exceptions import ConnectorValidationError
from esa.connectors.exceptions import UnexpectedValidationError
from esa.connectors.factory import instantiate_connector
from esa.connectors.interfaces import CheckpointedConnector
from esa.connectors.models import ConnectorFailure
from esa.connectors.models import ConnectorStopSignal
from esa.connectors.models import DocExtractionContext
from esa.connectors.models import Document
from esa.connectors.models import IndexAttemptMetadata
from esa.connectors.models import TextSection
from esa.db.connector import mark_cc_pair_as_permissions_synced
...
from esa.db.connector_credential_pair import get_last_successful_attempt_poll_range_end
from esa.db.connector_credential_pair import update_connector_credential_pair
from esa.db.constants import CONNECTOR_VALIDATION_ERROR_MESSAGE_PREFIX
...
from esa.db.enums import IndexModelStatus
...
from esa.db.index_attempt import get_recent_completed_attempts_for_cc_pair
...
from esa.db.index_attempt import transition_attempt_to_in_progress
from esa.db.index_attempt import update_docs_indexed
from esa.db.indexing_coordination import IndexingCoordination
from esa.db.models import IndexAttempt
from esa.db.models import IndexAttemptError
    ...
    try:
        ...
        while checkpoint.has_more:
            ...
            for document_batch, failure, next_checkpoint in connector_runner.run(
                ...
                index_attempt_md.request_id = make_randomized_esa_request_id("CIX")
    ...
    try:
        ...
        while checkpoint.has_more:
            ...
            for document_batch, failure, next_checkpoint in connector_runner.run(
                ...
                app.send_task(
                    ESACeleryTask.DOCPROCESSING_TASK,
                    kwargs=processing_batch_data,
                    queue=ESACeleryQueues.DOCPROCESSING,
