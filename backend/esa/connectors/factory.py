...
from esa.connectors.registry import CONNECTOR_CLASS_MAP
from esa.db.connector import fetch_connector_by_id
from esa.db.credentials import backend_update_credential_json
from esa.db.credentials import fetch_credential_by_id
...
def instantiate_connector(
    ...
    if isinstance(connector, CredentialsConnector):
        provider = ESADBCredentialsProvider(
