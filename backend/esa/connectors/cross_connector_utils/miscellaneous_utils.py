...
from esa.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
from esa.configs.constants import DocumentSource
from esa.configs.constants import IGNORE_FOR_QA
from esa.connectors.models import BasicExpertInfo
from esa.connectors.models import ESAMetadata
from esa.utils.logger import setup_logger
from esa.utils.text_processing import is_valid_email
...
def process_esa_metadata(
    metadata: dict[str, Any],
) -> tuple[ESAMetadata, dict[str, Any]]:
    """
    Users may set ESA metadata and custom tags in text files. https://docs.esa.app/admins/connectors/official/file
