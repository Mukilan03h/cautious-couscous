...
from esa.configs.app_configs import REQUEST_TIMEOUT_SECONDS
from esa.configs.app_configs import SHAREPOINT_CONNECTOR_SIZE_THRESHOLD
...
from esa.connectors.interfaces import IndexingHeartbeatInterface
...
from esa.connectors.models import ExternalAccess
...
from esa.connectors.sharepoint.connector_utils import get_sharepoint_external_access
from esa.file_processing.extract_file_text import ACCEPTED_IMAGE_FILE_EXTENSIONS
from esa.file_processing.extract_file_text import extract_text_and_images
from esa.file_processing.extract_file_text import get_file_ext
from esa.file_processing.extract_file_text import is_accepted_file_ext
from esa.file_processing.extract_file_text import ESAExtensionType
from esa.file_processing.file_validation import EXCLUDED_IMAGE_TYPES
from esa.file_processing.image_utils import store_image_and_create_section
...
def _convert_driveitem_to_document_with_permissions(
    ...
    if not content_bytes:
        ...
        # Note: we don't process ESA metadata for connectors like Drive & Sharepoint, but could
    ...
    def _load_from_checkpoint(
        ...
        if (
            ...
            for driveitem in driveitems:
                ...
                if not is_accepted_file_ext(driveitem_extension, ESAExtensionType.All):
                    logger.warning(
