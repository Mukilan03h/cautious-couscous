...
from esa.utils.text_processing import make_url_compatible
...
class DocumentBase(BaseModel):
    """Used for ESA ingestion api, the ID is inferred before use if not provided"""
...
class Document(DocumentBase):
    """Used for ESA ingestion api, the ID is required"""
