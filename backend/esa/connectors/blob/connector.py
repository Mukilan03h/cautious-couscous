...
from esa.configs.app_configs import BLOB_STORAGE_SIZE_THRESHOLD
from esa.configs.app_configs import INDEX_BATCH_SIZE
from esa.configs.constants import BlobType
            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"esa_blob_storage_{int(time.time())}",
                    )
    ...
    def _yield_blob_objects(
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                # Handle image files
                if is_accepted_file_ext(file_ext, ESAExtensionType.Multimedia):
                ...
                try:
                    ...
                    esa_metadata, custom_tags = process_esa_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = esa_metadata.file_display_name or file_name
                    time_updated = esa_metadata.doc_updated_at or last_modified
                    link = esa_metadata.link or link
                    primary_owners = esa_metadata.primary_owners
                    secondary_owners = esa_metadata.secondary_owners
                    source_type = esa_metadata.source_type or DocumentSource(
