...
from esa.configs.app_configs import ENABLE_EXPENSIVE_EXPERT_CALLS
from esa.configs.app_configs import INDEX_BATCH_SIZE
from esa.configs.app_configs import SLACK_NUM_THREADS
...
from esa.connectors.models import ConnectorCheckpoint
...
from esa.connectors.slack.access import get_channel_access
from esa.connectors.slack.models import ChannelType
from esa.connectors.slack.models import MessageType
from esa.connectors.slack.models import ThreadType
from esa.connectors.slack.esa_retry_handler import ESARedisSlackRetryHandler
from esa.connectors.slack.esa_slack_web_client import ESASlackWebClient
from esa.connectors.slack.utils import (
    expert_info_from_slack_id,
)
from esa.connectors.slack.utils import get_message_link
from esa.connectors.slack.utils import make_paginated_slack_api_call
from esa.connectors.slack.utils import SlackTextCleaner
...
class SlackConnector(
    ...
    def make_slack_web_client(
        ...
        # for concurrent workers. We've extended it with ESARedisSlackRetryHandler.
        ...
        esa_rate_limit_error_retry_handler = ESARedisSlackRetryHandler(
            max_retry_count=max_retry_count,
            delay_key=delay_key,
            r=r,
        )
        custom_retry_handlers: list[RetryHandler] = [
            ...
            esa_rate_limit_error_retry_handler,
        ]

        client = ESASlackWebClient(
...
if __name__ == "__main__":
    ...
    provider = ESAStaticCredentialsProvider(
