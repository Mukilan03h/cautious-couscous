...
from esa.connectors.google_drive.constants import DRIVE_FOLDER_TYPE
from esa.connectors.google_drive.constants import DRIVE_SHORTCUT_TYPE
from esa.connectors.google_drive.models import GDriveMimeType
from esa.connectors.google_drive.models import GoogleDriveFileType
from esa.connectors.google_drive.section_extraction import get_document_sections
from esa.connectors.google_drive.section_extraction import HEADING_DELIMITER
from esa.connectors.google_utils.resources import get_drive_service
from esa.connectors.google_utils.resources import get_google_docs_service
from esa.connectors.google_utils.resources import GoogleDocsService
...
from esa.file_processing.extract_file_text import ALL_ACCEPTED_FILE_EXTENSIONS
from esa.file_processing.extract_file_text import docx_to_text_and_images
...
from esa.file_processing.extract_file_text import pptx_to_text
from esa.file_processing.extract_file_text import read_pdf_file
from esa.file_processing.extract_file_text import xlsx_to_text
from esa.file_processing.file_validation import is_valid_image_type
...
def esa_document_id_from_drive_file(file: GoogleDriveFileType) -> str:
...
def _get_external_access_for_raw_gdrive_file(
    ...
    external_access_fn = cast(
        ...
        fetch_versioned_implementation_with_fallback(
            "esa.external_permissions.google_drive.doc_sync",
...
def _convert_drive_item_to_document(
    ...
    try:
        ...
        doc_id = esa_document_id_from_drive_file(file)
        external_access = (
...
def build_slim_document(
    ...
    return SlimDocument(
        id=esa_document_id_from_drive_file(file),
        external_access=external_access,
    )
