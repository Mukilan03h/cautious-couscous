...
from esa.configs.app_configs import GOOGLE_DRIVE_CONNECTOR_SIZE_THRESHOLD
from esa.configs.app_configs import INDEX_BATCH_SIZE
from esa.configs.app_configs import MAX_DRIVE_WORKERS
from esa.configs.constants import DocumentSource
from esa.connectors.exceptions import ConnectorValidationError
from esa.connectors.exceptions import CredentialExpiredError
from esa.connectors.exceptions import InsufficientPermissionsError
from esa.connectors.google_drive.doc_conversion import build_slim_document
from esa.connectors.google_drive.doc_conversion import (
    convert_drive_item_to_document,
)
from esa.connectors.google_drive.doc_conversion import esa_document_id_from_drive_file
from esa.connectors.google_drive.doc_conversion import PermissionSyncContext
from esa.connectors.google_drive.file_retrieval import crawl_folders_for_files
from esa.connectors.google_drive.file_retrieval import DriveFileFieldType
from esa.connectors.google_drive.file_retrieval import get_all_files_for_oauth
from esa.connectors.google_drive.file_retrieval import (
    get_all_files_in_my_drive_and_shared,
)
from esa.connectors.google_drive.file_retrieval import get_files_in_shared_drive
from esa.connectors.google_drive.file_retrieval import get_root_folder_id
from esa.connectors.google_drive.file_retrieval import has_link_only_permission
from esa.connectors.google_drive.models import DriveRetrievalStage
from esa.connectors.google_drive.models import GoogleDriveCheckpoint
from esa.connectors.google_drive.models import GoogleDriveFileType
from esa.connectors.google_drive.models import RetrievedDriveFile
from esa.connectors.google_drive.models import StageCompletion
from esa.connectors.google_utils.google_auth import get_google_creds
from esa.connectors.google_utils.google_utils import execute_paginated_retrieval
from esa.connectors.google_utils.google_utils import get_file_owners
from esa.connectors.google_utils.google_utils import GoogleFields
from esa.connectors.google_utils.resources import get_admin_service
from esa.connectors.google_utils.resources import get_drive_service
from esa.connectors.google_utils.resources import GoogleDriveService
from esa.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_PRIMARY_ADMIN_KEY,
)
from esa.connectors.google_utils.shared_constants import MISSING_SCOPES_ERROR_STR
from esa.connectors.google_utils.shared_constants import ONYX_SCOPE_INSTRUCTIONS
from esa.connectors.google_utils.shared_constants import SLIM_BATCH_SIZE
from esa.connectors.google_utils.shared_constants import USER_FIELDS
from esa.connectors.interfaces import CheckpointedConnectorWithPermSync
from esa.connectors.interfaces import CheckpointOutput
from esa.connectors.interfaces import GenerateSlimDocumentOutput
from esa.connectors.interfaces import SecondsSinceUnixEpoch
from esa.connectors.interfaces import SlimConnectorWithPermSync
from esa.connectors.models import ConnectorFailure
from esa.connectors.models import ConnectorMissingCredentialError
from esa.connectors.models import Document
from esa.connectors.models import EntityFailure
...
from esa.utils.threadpool_concurrency import parallel_yield
from esa.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from esa.utils.threadpool_concurrency import ThreadSafeDict
...
class GoogleDriveConnector(
    ...
    def _checkpointed_retrieval(
        ...
        for file in drive_files:
            ...
            try:
                document_id = esa_document_id_from_drive_file(drive_file)
