...
from esa.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_OBJECTS
from esa.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_PREFIXES
from esa.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_SUFFIXES
...
class ESASalesforce(Salesforce):
    ...
    def get_child_objects_by_id(
        ...
        while True:
            ...
            if len(child_relationships_batch) >= ESASalesforce.SOQL_MAX_SUBQUERIES:
                process_batch = True
            ...
            if process_batch:
                ...
                query = ESASalesforce._make_child_objects_by_id_query(
                    object_id,
                    sf_type,
