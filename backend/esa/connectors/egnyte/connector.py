...
from esa.configs.app_configs import EGNYTE_CLIENT_ID
from esa.configs.app_configs import EGNYTE_CLIENT_SECRET
...
from esa.connectors.interfaces import OAuthConnector
...
from esa.file_processing.extract_file_text import detect_encoding
...
from esa.file_processing.extract_file_text import is_text_file_extension
from esa.file_processing.extract_file_text import ESAExtensionType
from esa.file_processing.extract_file_text import read_text_file
from esa.utils.logger import setup_logger
from esa.utils.retry_wrapper import request_with_retries
...
def _process_egnyte_file(
    ...
    if not is_accepted_file_ext(
        extension, ESAExtensionType.Plain | ESAExtensionType.Document
    ):
    ...
    if is_text_file_extension(file_name):
        ...
        file_content_raw, file_metadata = read_text_file(
            file_content, encoding=encoding, ignore_esa_metadata=False
        )
    else:
