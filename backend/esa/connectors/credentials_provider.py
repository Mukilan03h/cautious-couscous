...
class ESADBCredentialsProvider(
    CredentialsProviderInterface["ESADBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "ESADBCredentialsProvider":
...
class ESAStaticCredentialsProvider(
    CredentialsProviderInterface["ESAStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "ESAStaticCredentialsProvider":
        return self
