...
from esa.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from esa.configs.app_configs import CONFLUENCE_TIMEZONE_OFFSET
from esa.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from esa.configs.app_configs import INDEX_BATCH_SIZE
from esa.configs.constants import DocumentSource
from esa.connectors.confluence.access import get_all_space_permissions
from esa.connectors.confluence.access import get_page_restrictions
from esa.connectors.confluence.esa_confluence import extract_text_from_confluence_html
from esa.connectors.confluence.esa_confluence import ESAConfluence
from esa.connectors.confluence.utils import build_confluence_document_id
from esa.connectors.confluence.utils import convert_attachment_to_content
from esa.connectors.confluence.utils import datetime_from_string
from esa.connectors.confluence.utils import update_param_in_path
from esa.connectors.confluence.utils import validate_attachment_filetype
from esa.connectors.credentials_provider import ESAStaticCredentialsProvider
...
from esa.connectors.interfaces import ConnectorCheckpoint
from esa.connectors.interfaces import ConnectorFailure
from esa.connectors.interfaces import CredentialsConnector
from esa.connectors.interfaces import CredentialsProviderInterface
...
from esa.connectors.interfaces import SlimConnector
from esa.connectors.interfaces import SlimConnectorWithPermSync
from esa.connectors.models import BasicExpertInfo
...
from esa.connectors.models import SlimDocument
...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: ESAConfluence | None = None
        self._low_timeout_confluence_client: ESAConfluence | None = None
    ...
    @property
    def confluence_client(self) -> ESAConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> ESAConfluence:
    ...
    def set_credentials_provider(
        ...
        confluence_client = ESAConfluence(
        ...
        low_timeout_confluence_client = ESAConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
...
if __name__ == "__main__":
    ...
    credentials_provider = ESAStaticCredentialsProvider(
        None,
