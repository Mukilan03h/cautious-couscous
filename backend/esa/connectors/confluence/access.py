...
def get_page_restrictions(
    ...
    Args:
        confluence_client: ESAConfluence client instance
    ...
    ee_get_all_page_restrictions = cast(
        Callable[
            [ESAConfluence, str, dict[str, Any], list[dict[str, Any]]],
            ExternalAccess | None,
        ],
        fetch_versioned_implementation(
            "esa.external_permissions.confluence.page_access", "get_page_restrictions"
        ),
    )
...
def get_all_space_permissions(
    ...
    ee_get_all_space_permissions = cast(
        ...
        fetch_versioned_implementation(
            "esa.external_permissions.confluence.space_access",
