...
# If the LLM fails to answer, ESA can still show the "Reference Documents"
ONYX_BOT_DISABLE_DOCS_ONLY_ANSWER = os.environ.get(
    "ONYX_BOT_DISABLE_DOCS_ONLY_ANSWER", ""
).lower() not in ["false", ""]
# When ESA is considering a message, what emoji does it react with
...
# What kind of message should be shown when someone gives an AI answer feedback to ESABot
...
# Should ESABot send an apology message if it's not able to find an answer
# That way the user isn't confused as to why ESABot reacted but then said nothing
...
# if ESABot couldn't find an answer
...
# responses ESABot can send in a given time period.
