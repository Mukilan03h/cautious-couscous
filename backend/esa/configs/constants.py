...
ONYX_DEFAULT_APPLICATION_NAME = "ESA"
...
TENANT_ID_COOKIE_NAME = "esa_tid"  # tenant id - for workaround cases
ANONYMOUS_USER_COOKIE_NAME = "esa_anonymous_user"

NO_AUTH_USER_ID = "__no_auth_user__"
NO_AUTH_USER_EMAIL = "anonymous@esa.app"
...
ONYX_METADATA_FILENAME = ".esa_metadata.json"

# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of ESA.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use ESA as a search engine."
)
...
DANSWER_API_KEY_DUMMY_EMAIL_DOMAIN = "esaapikey.ai"
...
KV_SETTINGS_KEY = "esa_settings"
KV_CUSTOMER_UUID_KEY = "customer_uuid"
KV_INSTANCE_DOMAIN_KEY = "instance_domain"
KV_ENTERPRISE_SETTINGS_KEY = "esa_enterprise_settings"
...
class DocumentSource(str, Enum):
    # Special case, document passed in via ESA APIs without specifying a source type
...
class MilestoneRecordType(str, Enum):
    ...
    CREATED_ONYX_BOT = "created_esa_bot"
...
class ESARedisConstants:
    ACTIVE_FENCES = "active_fences"


class ESACeleryPriority(int, Enum):
    HIGHEST = 0
    HIGH = auto()
    MEDIUM = auto()
    LOW = auto()
...
ONYX_CELERY_BEAT_HEARTBEAT_KEY = "esa:celery:beat:heartbeat"
...
project management, and collaboration tools into a single, customizable platform",
    ...
    DocumentSource.SERVICENOW: "servicenow - ITSM platform (incidents, problems, changes, knowledge, CMDB)",
}
