...
from esa.llm.llm_provider_options import OLLAMA_API_KEY_CONFIG_KEY
from esa.llm.llm_provider_options import OLLAMA_PROVIDER_NAME
from esa.llm.llm_provider_options import OPENROUTER_PROVIDER_NAME
from esa.llm.override_models import LLMOverride
from esa.llm.utils import get_max_input_tokens_from_llm_provider
...
from esa.utils.headers import build_llm_extra_headers
...
def _build_provider_extra_headers(
    ...
    # Passing these will put ESA on the OpenRouter leaderboard
