...
from esa.llm.constants import PROVIDER_DISPLAY_NAMES
from esa.llm.utils import model_supports_image_input
from esa.server.manage.llm.models import ModelConfigurationView
        ...
        WellKnownLLMProviderDescriptor(
            ...
            custom_config_keys=[
                ...
                CustomConfigKey(
                    ...
                    description="Choose how ESA should authenticate with Bedrock.",
                    is_required=False,
                    key_type=CustomConfigKeyType.SELECT,
        ...
        WellKnownLLMProviderDescriptor(
            ...
            custom_config_keys=[
                ...
                CustomConfigKey(
                    ...
                    "[Vertex AI configuration docs](https://docs.esa.app/admins/ai_models/google_ai) for all possible values.",
                    is_required=False,
                    is_secret=False,
...
# Display names for ESA-supported LLM providers (used in admin UI provider selection).
# These override PROVIDER_DISPLAY_NAMES for ESA-specific branding.
...
def get_provider_display_name(provider_name: str) -> str:
    """Get human-friendly display name for an ESA-supported provider.

    First checks ESA-specific display names, then falls back to
