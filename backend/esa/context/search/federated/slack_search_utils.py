...
from esa.configs.app_configs import MAX_SLACK_QUERY_EXPANSIONS
...
from esa.prompts.federated_search import SLACK_DATE_EXTRACTION_PROMPT
from esa.prompts.federated_search import SLACK_QUERY_EXPANSION_PROMPT
