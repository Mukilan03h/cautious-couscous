...
from esa.indexing.models import BaseChunk
from esa.indexing.models import IndexingSetting
from esa.tools.tool_implementations.web_search.models import WEB_SEARCH_PREFIX
...
class RetrievalDetails(ChunkContext):
    ...
    # Is this a real-time/streaming call or a question where ESA can take more time?
