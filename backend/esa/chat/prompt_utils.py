...
from esa.db.persona import get_default_behavior_persona
from esa.db.user_file import calculate_user_files_token_count
from esa.file_store.models import FileDescriptor
from esa.prompts.chat_prompts import CITATION_REMINDER
from esa.prompts.chat_prompts import CODE_BLOCK_MARKDOWN
from esa.prompts.chat_prompts import DEFAULT_SYSTEM_PROMPT
from esa.prompts.chat_prompts import REQUIRE_CITATION_GUIDANCE
from esa.prompts.chat_prompts import USER_INFO_HEADER
from esa.prompts.prompt_utils import get_company_context
from esa.prompts.prompt_utils import handle_esa_date_awareness
from esa.prompts.prompt_utils import replace_citation_guidance_tag
from esa.prompts.tool_prompts import GENERATE_IMAGE_GUIDANCE
from esa.prompts.tool_prompts import INTERNAL_SEARCH_GUIDANCE
from esa.prompts.tool_prompts import OPEN_URLS_GUIDANCE
from esa.prompts.tool_prompts import PYTHON_TOOL_GUIDANCE
from esa.prompts.tool_prompts import TOOL_DESCRIPTION_SEARCH_GUIDANCE
from esa.prompts.tool_prompts import TOOL_SECTION_HEADER
from esa.prompts.tool_prompts import WEB_SEARCH_GUIDANCE
...
def build_system_prompt(
    ...
    """
    system_prompt = handle_esa_date_awareness(base_system_prompt, datetime_aware)
