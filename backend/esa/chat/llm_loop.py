...
from esa.chat.citation_processor import DynamicCitationProcessor
from esa.chat.emitter import Emitter
from esa.chat.llm_step import run_llm_step
from esa.chat.llm_step import TOOL_CALL_MSG_ARGUMENTS
from esa.chat.llm_step import TOOL_CALL_MSG_FUNC_NAME
from esa.chat.models import ChatMessageSimple
from esa.chat.models import ExtractedProjectFiles
from esa.chat.models import LlmStepResult
from esa.chat.models import ProjectFileMetadata
from esa.chat.prompt_utils import build_reminder_message
from esa.chat.prompt_utils import build_system_prompt
from esa.chat.prompt_utils import (
...
from esa.context.search.models import SearchDocsResponse
...
from esa.llm.message_types import AssistantMessage
from esa.llm.message_types import ChatCompletionMessage
from esa.llm.message_types import ImageContentPart
from esa.llm.message_types import SystemMessage
from esa.llm.message_types import TextContentPart
from esa.llm.message_types import ToolCall
from esa.llm.message_types import ToolMessage
from esa.llm.message_types import UserMessageWithParts
from esa.llm.message_types import UserMessageWithText
from esa.llm.utils import model_needs_formatting_reenabled
from esa.prompts.chat_prompts import IMAGE_GEN_REMINDER
from esa.prompts.chat_prompts import OPEN_URL_REMINDER
from esa.server.query_and_chat.streaming_models import OverallStop
from esa.server.query_and_chat.streaming_models import Packet
from esa.tools.models import ToolCallInfo
from esa.tools.models import ToolResponse
from esa.tools.tool import Tool
from esa.tools.tool_implementations.images.image_generation_tool import (
    ImageGenerationTool,
)
from esa.tools.tool_implementations.images.models import (
    FinalImageGenerationResponse,
)
from esa.tools.tool_implementations.open_url.open_url_tool import OpenURLTool
from esa.tools.tool_implementations.search.search_tool import SearchTool
from esa.tools.tool_implementations.web_search.web_search_tool import WebSearchTool
from esa.tools.tool_runner import run_tool_calls
from esa.tracing.framework.create import trace
from esa.utils.b64 import get_image_type_from_bytes
...
def run_llm_loop(
    ...
    with trace("run_llm_loop", metadata={"tenant_id": get_current_tenant_id()}):
        ...
        from esa.llm.litellm_singleton.config import (
            initialize_litellm,
