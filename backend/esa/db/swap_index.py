...
from esa.db.document import delete_all_documents_for_connector_credential_pair
...
from esa.db.index_attempt import cancel_indexing_attempts_for_search_settings
from esa.db.index_attempt import (
    count_unique_active_cc_pairs_with_successful_index_attempts,
)
from esa.db.index_attempt import count_unique_cc_pairs_with_successful_index_attempts
