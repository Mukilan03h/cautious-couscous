...
from esa.configs.constants import DEFAULT_BOOST
from esa.configs.constants import DocumentSource
from esa.configs.kg_configs import KG_SIMPLE_ANSWER_MAX_DISPLAYED_SOURCES
from esa.db.chunk import delete_chunk_stats_by_connector_credential_pair__no_commit
...
from esa.db.entities import delete_from_kg_entities_extraction_staging__no_commit
from esa.db.enums import AccessType
from esa.db.enums import ConnectorCredentialPairStatus
from esa.db.feedback import delete_document_feedback_for_documents__no_commit
from esa.db.models import Connector
from esa.db.models import ConnectorCredentialPair
from esa.db.models import Credential
...
from esa.db.relationships import (
    delete_from_kg_relationships_extraction_staging__no_commit,
)
from esa.db.tag import delete_document_tags_for_documents__no_commit
from esa.db.utils import DocumentRow
from esa.db.utils import model_to_dict
...
def get_access_info_for_documents(
    ...
    - List of emails of ESA users with direct access to the doc (includes a "None" element if
