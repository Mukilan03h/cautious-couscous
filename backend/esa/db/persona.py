...
from esa.configs.app_configs import CURATORS_CANNOT_VIEW_OR_EDIT_NON_OWNED_ASSISTANTS
...
from esa.db.constants import SLACK_BOT_PERSONA_PREFIX
from esa.db.models import DocumentSet
from esa.db.models import Persona
from esa.db.models import Persona__User
from esa.db.models import Persona__UserGroup
from esa.db.models import PersonaLabel
from esa.db.models import StarterMessage
from esa.db.models import Tool
from esa.db.models import User
from esa.db.models import User__UserGroup
...
from esa.server.features.tool.tool_visibility import should_expose_tool_to_fe
...
def make_persona_private(
    ...
    if group_ids:
        raise NotImplementedError("ESA MIT does not support private Personas")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_make_persona_private = fetch_versioned_implementation(
            "esa.db.persona", "make_persona_private"
        )
