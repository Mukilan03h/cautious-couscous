...
from esa.auth.api_key import get_hashed_api_key_from_request
from esa.auth.email_utils import send_forgot_password_email
from esa.auth.email_utils import send_user_verification_email
from esa.auth.invited_users import get_invited_users
from esa.auth.invited_users import remove_user_from_invited_users
from esa.auth.jwt import verify_jwt_token
from esa.auth.pat import get_hashed_pat_from_request
from esa.auth.schemas import AuthBackend
from esa.auth.schemas import UserCreate
from esa.auth.schemas import UserRole
from esa.auth.schemas import UserUpdateWithRole
from esa.configs.app_configs import AUTH_BACKEND
from esa.configs.app_configs import AUTH_COOKIE_EXPIRE_TIME_SECONDS
from esa.configs.app_configs import AUTH_TYPE
from esa.configs.app_configs import DISABLE_AUTH
from esa.configs.app_configs import EMAIL_CONFIGURED
from esa.configs.app_configs import JWT_PUBLIC_KEY_URL
from esa.configs.app_configs import PASSWORD_MAX_LENGTH
from esa.configs.app_configs import PASSWORD_MIN_LENGTH
from esa.configs.app_configs import PASSWORD_REQUIRE_DIGIT
from esa.configs.app_configs import PASSWORD_REQUIRE_LOWERCASE
from esa.configs.app_configs import PASSWORD_REQUIRE_SPECIAL_CHAR
from esa.configs.app_configs import PASSWORD_REQUIRE_UPPERCASE
from esa.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from esa.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from esa.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from esa.configs.app_configs import TRACK_EXTERNAL_IDP_EXPIRY
...
from esa.configs.constants import ANONYMOUS_USER_COOKIE_NAME
from esa.configs.constants import AuthType
from esa.configs.constants import DANSWER_API_KEY_DUMMY_EMAIL_DOMAIN
from esa.configs.constants import DANSWER_API_KEY_PREFIX
...
from esa.configs.constants import PASSWORD_SPECIAL_CHARS
from esa.configs.constants import UNNAMED_KEY_PLACEHOLDER
from esa.db.api_key import fetch_user_for_api_key
from esa.db.auth import get_access_token_db
from esa.db.auth import get_default_admin_user_emails
from esa.db.auth import get_user_count
from esa.db.auth import get_user_db
from esa.db.auth import SQLAlchemyUserAdminDB
from esa.db.engine.async_sql_engine import get_async_session
from esa.db.engine.async_sql_engine import get_async_session_context_manager
from esa.db.engine.sql_engine import get_session_with_tenant
from esa.db.models import AccessToken
from esa.db.models import OAuthAccount
from esa.db.models import Persona
from esa.db.models import User
from esa.db.pat import fetch_user_for_pat
from esa.db.users import get_user_by_email
from esa.redis.redis_pool import get_async_redis_connection
...
from esa.utils.url import add_url_params
...
def anonymous_user_enabled(*, tenant_id: str | None = None) -> bool:
    ...
    value = redis_client.get(ESARedisLocks.ANONYMOUS_USER_ENABLED)
...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def create(
        ...
        tenant_id = await fetch_ee_implementation_or_noop(
            "esa.server.tenants.provisioning",
    ...
    async def on_after_register(
        ...
        get_marketing_posthog_cookie_name = fetch_ee_implementation_or_noop(
            module="esa.utils.posthog_client",
...
class FastAPIUserWithLogoutRouter(FastAPIUsers[models.UP, models.ID]):
    ...
    def get_refresh_router(
        ...
        from esa.auth.oauth_refresher import check_and_refresh_oauth_tokens
...
def get_default_admin_user_emails_() -> list[str]:
    # No default seeding available for ESA MIT
    return []
