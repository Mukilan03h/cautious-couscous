...
from esa.configs.app_configs import EMAIL_FROM
from esa.configs.app_configs import SENDGRID_API_KEY
from esa.configs.app_configs import SMTP_PASS
from esa.configs.app_configs import SMTP_PORT
from esa.configs.app_configs import SMTP_SERVER
from esa.configs.app_configs import SMTP_USER
...
from esa.configs.constants import ONYX_DISCORD_URL
...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@esa.app")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="esa.app")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    try:
        load_runtime_settings_fn = fetch_versioned_implementation(
            "esa.server.enterprise_settings.store", "load_runtime_settings"
        )
    ...
    cta_link = "https://www.esa.app/pricing"
    ...
    text_content = (
        ...
        "If you change your mind, visit https://www.esa.app/pricing"
    )
    send_email(
        user_email,
        subject,
