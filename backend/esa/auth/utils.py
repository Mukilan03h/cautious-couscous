...
from esa.auth.constants import API_KEY_HEADER_ALTERNATIVE_NAME
from esa.auth.constants import API_KEY_HEADER_NAME
from esa.auth.constants import API_KEY_PREFIX
from esa.auth.constants import BEARER_PREFIX
from esa.auth.constants import DEPRECATED_API_KEY_PREFIX
from esa.auth.constants import PAT_PREFIX
...
def get_hashed_bearer_token_from_request(
    ...
    Args:
        ...
        valid_prefixes: List of valid token prefixes (e.g., ["on_", "esa_pat_"])
