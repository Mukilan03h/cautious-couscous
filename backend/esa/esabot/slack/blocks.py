...
from esa.configs.esabot_configs import ONYX_BOT_NUM_DOCS_TO_DISPLAY
from esa.context.search.models import SearchDoc
from esa.db.chat import get_chat_session_by_message_id
from esa.db.engine.sql_engine import get_session_with_current_tenant
from esa.db.models import ChannelConfig
from esa.esabot.slack.constants import CONTINUE_IN_WEB_UI_ACTION_ID
...
from esa.esabot.slack.formatting import format_slack_message
from esa.esabot.slack.icons import source_to_github_img_link
from esa.esabot.slack.models import ActionValuesEphemeralMessage
from esa.esabot.slack.models import ActionValuesEphemeralMessageChannelConfig
from esa.esabot.slack.models import ActionValuesEphemeralMessageMessageInfo
from esa.esabot.slack.models import SlackMessageInfo
from esa.esabot.slack.utils import build_continue_in_web_ui_id
from esa.esabot.slack.utils import build_feedback_id
from esa.esabot.slack.utils import build_publish_ephemeral_message_id
from esa.esabot.slack.utils import remove_slack_text_interactions
from esa.esabot.slack.utils import translate_vespa_highlight_to_slack
from esa.utils.text_processing import decode_escapes
...
def build_slack_response_blocks(
    ...
    """
    # If called with the ESABot slash command, the question is lost so we have to reshow it
