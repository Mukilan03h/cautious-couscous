...
from esa.configs.app_configs import MCP_SERVER_CORS_ORIGINS
from esa.mcp_server.auth import ESATokenVerifier
from esa.mcp_server.utils import shutdown_http_client
from esa.utils.logger import setup_logger

logger = setup_logger()

logger.info("Creating ESA MCP Server...")

mcp_server = FastMCP(
    name="ESA MCP Server",
    version="1.0.0",
    auth=ESATokenVerifier(),
)
...
from esa.mcp_server.tools import search  # noqa: E402, F401
from esa.mcp_server.resources import indexed_sources  # noqa: E402, F401
...
def create_mcp_fastapi_app() -> FastAPI:
    ...
    # Authentication is handled by FastMCP's ESATokenVerifier (see auth.py)
