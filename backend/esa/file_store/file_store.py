...
from esa.configs.app_configs import AWS_REGION_NAME
from esa.configs.app_configs import S3_AWS_ACCESS_KEY_ID
from esa.configs.app_configs import S3_AWS_SECRET_ACCESS_KEY
from esa.configs.app_configs import S3_ENDPOINT_URL
from esa.configs.app_configs import S3_FILE_STORE_BUCKET_NAME
from esa.configs.app_configs import S3_FILE_STORE_PREFIX
from esa.configs.app_configs import S3_GENERATE_LOCAL_CHECKSUM
from esa.configs.app_configs import S3_VERIFY_SSL
from esa.configs.constants import FileOrigin
from esa.db.engine.sql_engine import get_session_with_current_tenant
from esa.db.engine.sql_engine import get_session_with_current_tenant_if_none
from esa.db.file_record import delete_filerecord_by_file_id
from esa.db.file_record import get_filerecord_by_file_id
from esa.db.file_record import get_filerecord_by_file_id_optional
from esa.db.file_record import get_filerecord_by_prefix
from esa.db.file_record import upsert_filerecord
from esa.db.models import FileRecord
from esa.db.models import FileRecord as FileStoreModel
from esa.file_store.s3_key_utils import generate_s3_key
from esa.utils.file import FileWithMimeType
...
class S3BackedFileStore(FileStore):
    ...
    def __init__(
        ...
        self._s3_prefix = s3_prefix or "esa-files"
...
def get_default_file_store() -> FileStore:
    ...
    - S3_FILE_STORE_PREFIX=<prefix> (optional, defaults to 'esa-files')
