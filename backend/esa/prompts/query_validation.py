...
from esa.prompts.constants import ANSWERABLE_PAT
from esa.prompts.constants import GENERAL_SEP_PAT
from esa.prompts.constants import QUESTION_PAT
from esa.prompts.constants import THOUGHT_PAT
...
{QUESTION_PAT.upper()} ESA is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to ESA being unreachable. \
Assuming the documents from search contains situations where ESA is not reachable and \
