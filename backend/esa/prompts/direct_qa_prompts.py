...
from esa.prompts.constants import DEFAULT_IGNORE_STATEMENT
from esa.prompts.constants import FINAL_QUERY_PAT
...
if __name__ == "__main__":
    print(JSON_PROMPT)  # Default prompt used in the ESA UI flow
