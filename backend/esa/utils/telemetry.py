...
from esa.configs.constants import KV_CUSTOMER_UUID_KEY
from esa.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
from esa.db.milestone import create_milestone_if_not_exists
...
_DANSWER_TELEMETRY_ENDPOINT = "https://telemetry.esa.app/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of ESA
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for ESA MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of ESA.
    fetch_versioned_implementation_with_fallback(
        module="esa.utils.telemetry",
