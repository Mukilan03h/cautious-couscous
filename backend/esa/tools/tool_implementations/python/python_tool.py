...
from esa.configs.app_configs import CODE_INTERPRETER_DEFAULT_TIMEOUT_MS
from esa.configs.app_configs import CODE_INTERPRETER_MAX_OUTPUT_LENGTH
from esa.configs.constants import FileOrigin
from esa.file_store.utils import build_full_frontend_file_url
...
from esa.tools.models import LlmPythonExecutionResult
from esa.tools.models import PythonExecutionFile
from esa.tools.models import PythonToolOverrideKwargs
from esa.tools.models import ToolResponse
from esa.tools.tool import Tool
from esa.tools.tool_implementations.python.code_interpreter_client import (
    CodeInterpreterClient,
)
from esa.tools.tool_implementations.python.code_interpreter_client import FileInput
        ...
        try:
            ...
            for workspace_file in response.files:
                ...
                try:
                    ...
                    # Save to ESA file store
                    esa_file_id = file_store.save_file(
                    ...
                    generated_files.append(
                        PythonExecutionFile(
                            filename=filename,
                            file_link=build_full_frontend_file_url(esa_file_id),
                        )
                    )
                    generated_file_ids.append(esa_file_id)
