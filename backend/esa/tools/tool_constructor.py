...
from esa.auth.oauth_token_manager import OAuthTokenManager
from esa.chat.emitter import Emitter
from esa.configs.app_configs import AZURE_IMAGE_API_BASE
from esa.configs.app_configs import AZURE_IMAGE_API_KEY
from esa.configs.app_configs import AZURE_IMAGE_API_VERSION
from esa.configs.app_configs import AZURE_IMAGE_DEPLOYMENT_NAME
from esa.configs.app_configs import IMAGE_MODEL_NAME
...
from esa.db.mcp import get_all_mcp_tools_for_server
...
from esa.db.oauth_config import get_oauth_config
...
from esa.tools.built_in_tools import get_built_in_tool_by_id
from esa.tools.models import DynamicSchemaInfo
from esa.tools.tool import Tool
from esa.tools.tool_implementations.custom.custom_tool import (
    build_custom_tools_from_openapi_schema_and_headers,
)
from esa.tools.tool_implementations.images.image_generation_tool import (
    ImageGenerationTool,
)
from esa.tools.tool_implementations.mcp.mcp_tool import MCPTool
from esa.tools.tool_implementations.open_url.open_url_tool import (
    OpenURLTool,
)
from esa.tools.tool_implementations.python.python_tool import PythonTool
from esa.tools.tool_implementations.search.search_tool import SearchTool
from esa.tools.tool_implementations.web_search.web_search_tool import (
    WebSearchTool,
)
from esa.utils.headers import header_dict_to_header_list
        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Web Search Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Internet search tool requires a search provider API key, please contact your ESA admin to get it added!"
                    )
            ...
            # Handle Open URL Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Open URL tool requires a web content provider, please contact your ESA admin to get it configured!"
                    )
