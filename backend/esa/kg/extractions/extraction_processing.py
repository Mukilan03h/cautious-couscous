...
from esa.background.celery.tasks.kg_processing.utils import extend_lock
from esa.configs.constants import CELERY_GENERIC_BEAT_LOCK_TIMEOUT
from esa.db.connector import get_kg_enabled_connectors
from esa.db.document import get_document_updated_at
from esa.db.document import get_skipped_kg_documents
from esa.db.document import get_unprocessed_kg_document_batch_for_connector
from esa.db.document import update_document_kg_info
from esa.db.document import update_document_kg_stage
from esa.db.engine.sql_engine import get_session_with_current_tenant
from esa.db.entities import delete_from_kg_entities__no_commit
from esa.db.entities import upsert_staging_entity
from esa.db.entity_type import get_entity_types
from esa.db.kg_config import get_kg_config_settings
from esa.db.kg_config import validate_kg_settings
from esa.db.models import Document
from esa.db.models import KGStage
from esa.db.relationships import delete_from_kg_relationships__no_commit
from esa.db.relationships import upsert_staging_relationship
from esa.db.relationships import upsert_staging_relationship_type
...
from esa.kg.models import KGEntityTypeInstructions
from esa.kg.models import KGExtractionInstructions
from esa.kg.models import KGImpliedExtractionResults
from esa.kg.utils.extraction_utils import EntityTypeMetadataTracker
from esa.kg.utils.extraction_utils import (
    get_batch_documents_metadata,
)
from esa.kg.utils.extraction_utils import kg_deep_extraction
from esa.kg.utils.extraction_utils import (
    kg_implied_extraction,
)
from esa.kg.utils.formatting_utils import extract_relationship_type_id
from esa.kg.utils.formatting_utils import get_entity_type
from esa.kg.utils.formatting_utils import split_entity_id
