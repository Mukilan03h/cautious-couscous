...
from esa.configs.kg_configs import KG_NORMALIZATION_RERANK_LEVENSHTEIN_WEIGHT
from esa.configs.kg_configs import KG_NORMALIZATION_RERANK_NGRAM_WEIGHTS
from esa.configs.kg_configs import KG_NORMALIZATION_RERANK_THRESHOLD
from esa.configs.kg_configs import KG_NORMALIZATION_RETRIEVE_ENTITIES_LIMIT
from esa.db.engine.sql_engine import get_session_with_current_tenant
from esa.db.models import KGEntity
from esa.db.relationships import get_relationships_for_entity_type_pairs
from esa.kg.models import NormalizedEntities
from esa.kg.models import NormalizedRelationships
from esa.kg.utils.embeddings import encode_string_batch
from esa.kg.utils.formatting_utils import format_entity_id_for_models
from esa.kg.utils.formatting_utils import get_attributes
from esa.kg.utils.formatting_utils import get_entity_type
from esa.kg.utils.formatting_utils import make_entity_w_attributes
