...
from esa.configs.constants import ESACallTypes
from esa.configs.kg_configs import KG_METADATA_TRACKING_THRESHOLD
from esa.db.engine.sql_engine import get_session_with_current_tenant
from esa.db.entities import get_kg_entity_by_document
from esa.db.entity_type import get_entity_types
from esa.db.kg_config import KGConfigSettings
from esa.db.models import Document
from esa.db.models import KGEntityType
from esa.db.models import KGRelationshipType
from esa.db.tag import get_structured_tags_for_document
from esa.kg.models import KGAttributeEntityOption
from esa.kg.models import KGAttributeTrackInfo
from esa.kg.models import KGAttributeTrackType
from esa.kg.models import KGChunkFormat
from esa.kg.models import KGClassificationInstructions
from esa.kg.models import KGClassificationResult
from esa.kg.models import KGDocumentDeepExtractionResults
from esa.kg.models import KGEnhancedDocumentMetadata
from esa.kg.models import KGImpliedExtractionResults
from esa.kg.models import KGMetadataContent
from esa.kg.utils.formatting_utils import extract_email
from esa.kg.utils.formatting_utils import get_entity_type
from esa.kg.utils.formatting_utils import kg_email_processing
from esa.kg.utils.formatting_utils import make_entity_id
from esa.kg.utils.formatting_utils import make_relationship_id
from esa.kg.utils.formatting_utils import make_relationship_type_id
from esa.kg.vespa.vespa_interactions import get_document_vespa_contents
from esa.llm.factory import get_default_llms
from esa.llm.utils import message_to_string
from esa.prompts.kg_prompts import CALL_CHUNK_PREPROCESSING_PROMPT
from esa.prompts.kg_prompts import CALL_DOCUMENT_CLASSIFICATION_PROMPT
from esa.prompts.kg_prompts import GENERAL_CHUNK_PREPROCESSING_PROMPT
from esa.prompts.kg_prompts import MASTER_EXTRACTION_PROMPT
...
def kg_implied_extraction(
    ...
    document_is_from_call = document_entity_type.lower() in (
        call_type.value.lower() for call_type in ESACallTypes
    )
...
def kg_classify_document(
    ...
    if entity_type not in (call_type.value for call_type in ESACallTypes):
        return None
...
def kg_deep_extract_chunks(
    ...
    entity_type = get_entity_type(document_entity)
    is_call = entity_type in (call_type.value for call_type in ESACallTypes)
