...
from esa.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
from esa.configs.app_configs import INTEGRATION_TESTS_MODE
from esa.configs.app_configs import MANAGED_VESPA
from esa.configs.app_configs import VESPA_NUM_ATTEMPTS_ON_STARTUP
from esa.configs.chat_configs import INPUT_PROMPT_YAML
from esa.configs.constants import KV_REINDEX_KEY
from esa.configs.constants import KV_SEARCH_SETTINGS
from esa.configs.embedding_configs import SUPPORTED_EMBEDDING_MODELS
from esa.configs.embedding_configs import SupportedEmbeddingModel
from esa.configs.model_configs import FAST_GEN_AI_MODEL_VERSION
from esa.configs.model_configs import GEN_AI_API_KEY
from esa.configs.model_configs import GEN_AI_MODEL_VERSION
from esa.context.search.models import SavedSearchSettings
from esa.context.search.retrieval.search_runner import (
    download_nltk_data,
)
from esa.db.connector import check_connectors_exist
from esa.db.connector import create_initial_default_connector
from esa.db.connector_credential_pair import associate_default_cc_pair
from esa.db.connector_credential_pair import get_connector_credential_pairs
from esa.db.connector_credential_pair import resync_cc_pair
from esa.db.credentials import create_initial_public_credential
from esa.db.document import check_docs_exist
from esa.db.enums import EmbeddingPrecision
from esa.db.index_attempt import cancel_indexing_attempts_past_model
from esa.db.index_attempt import expire_index_attempts
from esa.db.llm import fetch_default_provider
from esa.db.llm import update_default_provider
from esa.db.llm import upsert_llm_provider
from esa.db.search_settings import get_active_search_settings
...
from esa.db.search_settings import update_current_search_settings
from esa.db.search_settings import update_secondary_search_settings
...
from esa.document_index.vespa.index import VespaIndex
from esa.indexing.models import IndexingSetting
from esa.key_value_store.factory import get_kv_store
from esa.key_value_store.interface import KvKeyNotFoundError
from esa.llm.llm_provider_options import get_openai_model_names
...
from esa.natural_language_processing.search_nlp_models import warm_up_cross_encoder
from esa.seeding.load_yamls import load_input_prompts_from_yaml
from esa.server.manage.llm.models import LLMProviderUpsertRequest
from esa.server.manage.llm.models import ModelConfigurationUpsertRequest
from esa.server.settings.store import load_settings
from esa.server.settings.store import store_settings
from esa.utils.gpu_utils import gpu_status_request
...
def setup_esa(
    ...
    """
    Setup ESA for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_esa() -> None:
