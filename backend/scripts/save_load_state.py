...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ESA checkpoint saving and loading.")
    parser.add_argument(
        "--save", action="store_true", help="Save ESA state to directory."
    )
    parser.add_argument(
        "--load", action="store_true", help="Load ESA state from save directory."
    )
    parser.add_argument(
        "--postgres_container_name",
        type=str,
        default="esa-relational_db-1",
        help="Name of the postgres container to dump",
    )
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default=os.path.join("..", "esa_checkpoint"),
