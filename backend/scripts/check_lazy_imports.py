...
_LAZY_IMPORT_MODULES_TO_IGNORE_SETTINGS: Dict[str, LazyImportSettings] = {
    ...
    "esa.llm.litellm_singleton": LazyImportSettings(),
    "litellm": LazyImportSettings(
        ignore_files={
            "esa/llm/litellm_singleton/__init__.py",
            "esa/llm/litellm_singleton/config.py",
            "esa/llm/litellm_singleton/monkey_patches.py",
        }
    ),
