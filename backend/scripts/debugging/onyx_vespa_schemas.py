"""Tool to generate all supported schema variations for ESA Cloud's Vespa database.

Usage:

```
PYTHONPATH=. python scripts/debugging/esa_vespa_schemas.py
```
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="esa/document_index/vespa/app_config/schemas/danswer_chunk.sd.jinja",
    )
    parser.add_argument(
        "--cloud-services-template",
        help="The cloud-services.xml.jinja template path",
        default="ee/esa/document_index/vespa/app_config/cloud-services.xml.jinja",
    )
    parser.add_argument(
        "--output-path",
